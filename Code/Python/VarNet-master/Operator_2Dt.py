...
vertices = np.array([[0.0, -0.5], [0.0, -0.2], [0.0, 0.2], [0.0, 0.5], [2.0, 0.5], [2.0, -0.5]])
...
# VarNet_2d = VarNet(ADPDE_2d, layerWidth=[10, 20], discNum=[80, 40], bDiscNum=40, tDiscNum=75, processors='CPU:0')
VarNet_2d = VarNet(ADPDE_2d, layerWidth=[10, 20], discNum=[20, 20], bDiscNum=20, tDiscNum=20, processors='CPU:0')
