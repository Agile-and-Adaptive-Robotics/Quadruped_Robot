...
# ------------------------------------------------------------ DEFINE PDE PARAMETERS & ANALYTICAL SOLUTION ------------------------------------------------------------
...
# Setup the AD-PDE:
ADPDE_1dt = ADPDE(domain, diff=D, vel=u, timeDependent=True, tInterval=[0, T], IC=IC, cEx=cExact)
# ADPDE_1dt.plotIC()
...
# VarNet_1dt = VarNet(ADPDE_1dt, layerWidth=[20], discNum=20, bDiscNum=None, tDiscNum=300, processors='GPU:0')          # It looks like bDiscNum must be set to a non [] value...

# VarNet_1dt = VarNet(ADPDE_1dt, layerWidth=[20], discNum=20, bDiscNum=None, tDiscNum=300, processors='CPU:0')
VarNet_1dt = VarNet(ADPDE_1dt, layerWidth=[20], discNum=20, bDiscNum=None, tDiscNum=100, processors='CPU:0')
...
folderpath = r'C:\Users\USER\Documents\GitHub\Quadruped_Robot\Code\Python\VarNet-master\Checkpoints\TF_checkpoint'
...
# VarNet_1dt.train(folderpath, weight=[1.e1, 1.e1, 1.], smpScheme='uniform', adjustWeight=True)
...
#
# # Load the model:
# folderpath2 = r'C:\Users\USER\Downloads\Checkpoints\TF_checkpoint'
