 ...
 * Equation_Test
 * 
 * Test control of hip angle using best fit equations
 * 
 * Author: Flora Huang
 ...
 */
  if (targetHip <= -44.739) {
    ...
    currHip = Hip2;
  } else if (targetHip <= 29.31) {
    dtOnHip = exp((targetHip - 28.8104) / 0.112872);
    currHip = Hip2;
  } else {
    dtOnHip = -1;   // Return invalid value
  }
}
 ...
 */
  unsigned long timeInterval = 1000;   // [ms] Time between each print
