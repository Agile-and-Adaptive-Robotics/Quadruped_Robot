function s = OpenSerialPort( Port, BaudRate )

%This function opens serial port communication with the Arduino.  It waits for the connection to open before proceeding and clears any preexisting commands.
