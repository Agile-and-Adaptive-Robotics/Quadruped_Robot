...
ROAToolboxOptions.InitCircleRad = 0.2;
ROAToolboxOptions.InitCircleCen = [ 1; 0 ];

%% Parameters for integrating
% End time for integrate.
ROAToolboxOptions.IntegratorTime = 50;
