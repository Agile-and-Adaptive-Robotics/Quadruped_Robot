...
% ROAToolboxOptions.GridCellSize = [0.03; 0.03]; % high accuracy, cost long time
ROAToolboxOptions.GridCellSize = [0.3; 0.3]; % low accuracy, quick
...
ROAToolboxOptions.IntegratorTime = 0.4;
...
save('ROAProjectOptions', 'ROAToolboxOptions');
% --------------------------------------------
...
if iscell(xs)  % element-wise
    ...
    x1dot = - 50 * x1 - 16 * x2 + 13.8 * x1 .* x2;
    x2dot = 13 * x1 - 9 * x2 + 5.5 * x1 .* x2;
