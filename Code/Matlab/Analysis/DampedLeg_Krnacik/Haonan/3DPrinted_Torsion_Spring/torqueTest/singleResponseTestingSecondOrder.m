...
data = S2L5LT12ST100I.(torqueName).(direction).trial1;     % choose a spring to analyze
mgr = S2L5LT12ST100I.(torqueName).mgrValue/1000;             % [Nm] mass*gravity*pulley radius

% physical parameters
I1 = 3075788.68/1000^2;         % [kg*m^2]      inertia of the pulley and hex rod from Solidworks
r1 = 125/1000;             % [m]           radius of the pulley
...
plotTitleCropped = {springName +  " " + direction +  " " + 'Normalized Cropped First Order Step Response'};
fileTitleCropped = springName + " " + direction + " " + ' Normalized Cropped First Order Step Response';
...
plotTitle = springName + " " + torqueName + " " + direction + ' Full Second Order Ramp Response';
title(plotTitle)
hold off