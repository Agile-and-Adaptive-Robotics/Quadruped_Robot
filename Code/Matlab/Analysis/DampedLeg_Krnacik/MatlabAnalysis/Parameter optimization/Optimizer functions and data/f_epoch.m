...
for m = 1:length(X)
    ...
    cost_ankle = sum(sumdiffsq);
    
    % Calculate total cost of particle
    pbest_err(m) = 200 * cost_hip + cost_knee + cost_ankle;
