...
mu1_value = 0;                          % [Ns/m]
b2_value = knee_var;                    % [Ns/m]
k2_value = U;                           % [N/m]
mu2_value = 0;                          % [Ns/m]
b3_value = ankle_var(1);                % [Ns/m]
k3_value = ankle_var(2);                % [N/m]
mu3_value = 0;                          % [Ns/m]                       
...
% Calculate cost
cost = abs( zeta_sim - jdataProp.zetas(muscles) ) + abs( omega_sim - jdataProp.omegas(muscles) ) + 5*pk_diff + locs_diff;
cost = sum(cost);
end
