...
R1 = 0.01 * 1.305;                  % [m]
L1 = 0.01 * 2.9;                    % [m]
I1 = (1/3) * M1 * (2*R1)^2;             % [kg*m^2]


% Define the mechanical properties of link 2.
M2 = 0.001 * 9.06;                  % [kg]
R2 = 0.01 * 1.558;                  % [m]
I2 = (1/3) * M2 * R2^2;             % [kg*m^2]
L2 = 0.01 * 4.1;                    % [m]

% Define the mechanical properties of link 3.
M3 = 0.001 * 1.7;                   % [kg]
R3 = 0.01 * 1.6;                    % [m]
I3 = (1/3) * M3 * R3^2;             % [kg*m^2]
L3 = 0.01 * 3.3;                    % [m]
...
% Run the simulation
[t,x] = ode45(@(t,x) Dynamic_code_Rat_complex_Hunt(t,x,P,U),time,x0);
