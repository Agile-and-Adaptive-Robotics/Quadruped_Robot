...
syms t kse kpe b k kt ct L m T dT u theta(t) Pa1x Pa1y Pa1z Pa2x Pa2y Pa2z Pa30x Pa30y Pa30z Pb1x Pb1y Pb1z Pb2x Pb2y Pb2z Pb30x Pb30y Pb30z ddeltaLa x1 dx1 x2 dx2 x3 dx3
...
eq2 = I*ddtheta + ct*dtheta + kt*theta == Ma_vec(3) + Mb_vec(3);
...
eq1 = subs( eq1, [ theta, dtheta, ddtheta, T, dT ], [ x1, x2, dx2, x3, dx3 ] );
eq2 = subs( eq2, [ theta, dtheta, ddtheta, T, dT ], [ x1, x2, dx2, x3, dx3 ] );

% Solve the equations for the flow variables.
sol = solve( [ eq1 eq2 eq3 ], [ dx1 dx2 dx3 ] );
