%% Phase Shifted Multistate CPGs

% This script simulates a collect of phase shfited CPG network with arbitrarily many states.
...
% Compute the desired steady state values.
Ustar = deltas; Ustar(1:(1 + size(Ustar, 1)):end) = diag(Rs);
