...
[ c2, x3_max, Gna1, Gna2, Gna3, dEs31, dEs32, gs31, gs32, Ia3 ] = network.unpack_relative_division_output_params( division_output_params, network.neuron_manager, network.synapse_manager, network.applied_current_manager, undetected_option );
...
% Compute the desired and achieved division steady state output.
U3s_flat_desired = network.compute_encoded_desired_relative_division_sso( U1s_flat, U2s_flat, c1, c3, delta, x1_max, R1, R2, R3, network.neuron_manager, undetected_option, network.network_utilities );
...
% Plot the encoded desired and achieved subnetwork formulation results.
fig = figure( 'Color', 'w', 'Name', 'RD: Encoded Desired & Achieved (Theory) SS Behavior' ); hold on, grid on, rotate3d on, view( 135, 15 ), xlabel( 'Encoded Input 1, U1 [mV]' ), ylabel( 'Encoded Input 2, U2 [mV]' ), zlabel( 'Encoded Output, U3 [mV]' ), title( 'RD: Encoded Desired & Achieved (Theory) SS Behavior' )
...
saveas( fig, [ save_directory, '\', 'relative_division_desired_achieved_theory_encoded' ] )

% Plot the decoded desired and achieved subnetwork formulation results.
fig = figure( 'Color', 'w', 'Name', 'RD: Decoded Desired & Achieved (Theory) SS Behavior' ); hold on, grid on, rotate3d on, view( 135, 15 ), xlabel( 'Decoded Input 1, x1 [-]' ), xlabel( 'Decoded Input 2, x2 [-]' ), zlabel( 'Decoded Output, x3 [-]' ), title( 'RD: Decoded Desired & Achieved (Theory) SS Behavior' )
...
legend( 'Desired', 'Theoretically Achieved', 'Location', 'Best' )
saveas( fig, [ save_directory, '\', 'relative_division_desired_achieved_theory_decoded' ] )

% Plot the RK4 maximum timestep vs the encoded input.
fig = figure( 'Color', 'w', 'Name', 'RD: RK4 Maximum Timestep vs Encoded Input' ); hold on, grid on, rotate3d on, view( 135, 15 ), xlabel( 'Encoded Input 1, U1 [mV]' ), ylabel( 'Encoded Input 2, U2 [mV]' ), zlabel( 'RK4 Maximum Timestep, dt [s]' ), title( 'RD: RK4 Maximum Timestep vs Encoded Input' )
surf( scale*Us_grid_desired( :, :, 1 ), scale*Us_grid_desired( :, :, 2 ), dts_grid, 'Edgecolor', 'None', 'Facecolor', 'b', 'Facealpha', 0.70 )
saveas( fig, [ save_directory, '\', 'relative_division_rk4_maximum_timestep_encoded' ] )

% Plot the RK4 maximum timestep vs the decoded input.
fig = figure( 'Color', 'w', 'Name', 'RD: RK4 Maximum Timestep vs Decoded Input' ); hold on, grid on, rotate3d on, view( 135, 15 ), xlabel( 'Decoded Input 1, x1 [-]' ), ylabel( 'Decoded Input 2, x2 [-]' ), zlabel( 'RK4 Maximum Timestep, dt [s]' ), title( 'RD: RK4 Maximum Timestep vs Decoded Input' )
surf( scale*Xs_grid_desired( :, :, 1 ), scale*Xs_grid_desired( :, :, 2 ), dts_grid, 'Edgecolor', 'None', 'Facecolor', 'b', 'Facealpha', 0.70 )
saveas( fig, [ save_directory, '\', 'relative_division_rk4_maximum_timestep_decoded' ] )

% Plot the linearized system condition numbers vs the encoded input.
fig = figure( 'Color', 'w', 'Name', 'RD: Condition Numbers vs Encoded Input' ); hold on, grid on, rotate3d on, view( 135, 15 ), xlabel( 'Encoded Input 1, U1 [mV]' ), ylabel( 'Encoded Input 2, U2 [mV]' ), zlabel( 'Condition Number, k [-]' ), title( 'RD: Condition Number vs Encoded Input' )
surf( scale*Us_grid_desired( :, :, 1 ), scale*Us_grid_desired( :, :, 2 ), condition_numbers_grid, 'Edgecolor', 'None', 'Facecolor', 'b', 'Facealpha', 0.70 )
saveas( fig, [ save_directory, '\', 'relative_division_condition_numbers_encoded' ] )

% Plot the linearized system condition numbers vs the decoded input.
fig = figure( 'Color', 'w', 'Name', 'RD: Condition Numbers vs Decoded Input' ); hold on, grid on, rotate3d on, view( 135, 15 ), xlabel( 'Decoded Input 1, x1 [-]' ), ylabel( 'Decoded Input 2, x2 [-]' ), zlabel( 'Condition Number, k [-]' ), title( 'RD: Condition Number vs Decoded Input' )
surf( scale*Xs_grid_desired( :, :, 1 ), scale*Xs_grid_desired( :, :, 2 ), condition_numbers_grid, 'Edgecolor', 'None', 'Facecolor', 'b', 'Facealpha', 0.70 )
saveas( fig, [ save_directory, '\', 'relative_division_condition_numbers_decoded' ] )
...
if simulate_flag                            % If we want to simulate the network...
    ...
    save( [ save_directory, '\', 'relative_division_subnetwork_error' ], 'xs1_input', 'xs2_input', 'Us1_input', 'Us2_input', 'Ias1_input', 'Ias2_input', 'Us_grid_achieved_numerical', 'Xs_grid_achieved_numerical' )
...
Us3_flat_desired = network.compute_encoded_desired_relative_division_sso( Us1_flat, Us2_flat, c1, c3, delta, x1_max, R1, R2, R3, network.neuron_manager, undetected_option, network.network_utilities );
...
header_str_encoded = 'Relative Division Encoded Summary Statistics\n';
header_str_decoded = 'Relative Division Decoded Summary Statistics\n';
...
% Print the subnetwork encoded summary statistics.
...
fig = figure( 'Color', 'w', 'Name', 'RD: Encoded Steady State Response (Desired)' ); hold on, grid on, rotate3d on, view( 135, 30 ), xlabel( 'Encoded Input 1, U1 [mV]' ), ylabel( 'Encoded Input 2, U2 [mV]' ), zlabel( 'Encoded Output, U3 [mV]' ), title( 'RD: Encoded Steady State Response (Desired)' )
surf( scale*Us_grid_desired( :, :, 1 ), scale*Us_grid_desired( :, :, 2 ), scale*Us_grid_desired( :, :, 3 ), 'Edgecolor', 'None', 'Facecolor', 'b', 'Facealpha', 0.7 )
saveas( fig, [ save_directory, '\', 'relative_division_sso_desired_encoded' ] )

% Create a plot of the decoded desired network behavior.
fig = figure( 'Color', 'w', 'Name', 'RD: Decoded Steady State Response (Desired)' ); hold on, grid on, rotate3d on, view( 135, 30 ), xlabel( 'Decoded Input 1, x1 [-]' ), ylabel( 'Decoded Input 2, x2 [-]' ), zlabel( 'Decoded Output, x3 [-]' ), title( 'RD: Decoded Steady State Response (Desired)' )
surf( scale*Xs_grid_desired( :, :, 1 ), scale*Xs_grid_desired( :, :, 2 ), scale*Xs_grid_desired( :, :, 3 ), 'Edgecolor', 'None', 'Facecolor', 'b', 'Facealpha', 0.7 )
saveas( fig, [ save_directory, '\', 'relative_division_sso_desired_decoded' ] )

% Create a plot of the encoded achieved numerical network behavior.
fig = figure( 'Color', 'w', 'Name', 'RD: Encoded Steady State Response (Achieved Theoretical)' ); hold on, grid on, rotate3d on, view( 135, 30 ), xlabel( 'Encoded Input 1, U1 [mV]' ), ylabel( 'Encoded Input 2, U2 [mV]' ), zlabel( 'Encoded Output, U3 [mV]' ), title( 'RD: Encoded Steady State Response (Achieved Theoretical)' )
...
saveas( fig, [ save_directory, '\', 'relative_division_sso_achieved_theoretical_encoded' ] )

% Create a plot of the decoded achieved numerical network behavior.
fig = figure( 'Color', 'w', 'Name', 'RD: Decoded Steady State Response (Achieved Theoretical)' ); hold on, grid on, rotate3d on, view( 135, 30 ), xlabel( 'Decoded Input 1, x1 [-]' ), ylabel( 'Decoded Input 2, x2 [-]' ), zlabel( 'Decoded Output, x3 [-]' ), title( 'RD: Decoded Steady State Response (Achieved Theoretical)' )
...
saveas( fig, [ save_directory, '\', 'relative_division_sso_achieved_theoretical_decoded' ] )

% Create a plot of the encoded achieved numerical network behavior.
fig = figure( 'Color', 'w', 'Name', 'RD: Encoded Steady State Response (Achieved Numerical)' ); hold on, grid on, rotate3d on, view( 135, 30 ), xlabel( 'Encoded Input 1, U1 [mV]' ), ylabel( 'Encoded Input 2, U2 [mV]' ), zlabel( 'Encoded Output, U3 [mV]' ), title( 'RD: Encoded Steady State Response (Achieved Numerical)' )
...
saveas( fig, [ save_directory, '\', 'relative_division_sso_achieved_numerical_encoded' ] )

% Create a plot of the decoded achieved numerical network behavior.
fig = figure( 'Color', 'w', 'Name', 'RD: Decoded Steady State Response (Achieved Numerical)' ); hold on, grid on, rotate3d on, view( 135, 30 ), xlabel( 'Decoded Input 1, x1 [-]' ), ylabel( 'Decoded Input 2, x2 [-]' ), zlabel( 'Decoded Output, x3 [-]' ), title( 'RD: Decoded Steady State Response (Achieved Numerical)' )
...
saveas( fig, [ save_directory, '\', 'relative_division_sso_achieved_numerical_decoded' ] )

% Create a plot of the encoded desired, achieved (theory), and achieved (numerical) network behavior.
fig = figure( 'Color', 'w', 'Name', 'RD: Encoded Steady State Response (Comparison)' ); hold on, grid on, rotate3d on, view( 135, 30 ), xlabel( 'Encoded Input, U1 [mV]' ), ylabel( 'Encoded Output, U2 [mV]' ), title( 'RD: Encoded Steady State Response (Comparison)' )
...
saveas( fig, [ save_directory, '\', 'relative_division_sso_comparison_encoded' ] )

% Create a plot of the decoded desired, achieved (theory), and achieved (numerical) network behavior.
fig = figure( 'Color', 'w', 'Name', 'RD: Decoded Steady State Response (Comparison)' ); hold on, grid on, rotate3d on, view( 135, 30 ), xlabel( 'Decoded Input 1, x1 [-]' ), ylabel( 'Decoded Input 2, x2 [-]' ), zlabel( 'Decoded Output, x3 [-]' ), title( 'RD: Decoded Steady State Response (Comparison)' )
...
legend( [ h1, h2, h3 ], { 'Desired', 'Achieved (Theoretical)', 'Achieved (Numerical)' }, 'Location', 'Best' )
saveas( fig, [ save_directory, '\', 'relative_division_sso_comparison_decoded' ] )

% Create a plot of the encoded theoretical and numerical error.
fig = figure( 'Color', 'w', 'Name', 'RD: Encoded Steady State Error' ); hold on, grid on, rotate3d on, view( 135, 30 ), xlabel( 'Encoded Input 1, U1 [mV]' ), ylabel( 'Encoded Input 2, U2 [mV]' ), zlabel( 'Encoded Error, E [mV]' ), title( 'RD: Encoded Steady State Error' )
...
saveas( fig, [ save_directory, '\', 'relative_division_sse_encoded' ] )

% Create a plot of the decoded theoretical and numerical error.
fig = figure( 'Color', 'w', 'Name', 'RD: Decoded Steady State Error' ); hold on, grid on, rotate3d on, view( 135, 30 ), xlabel( 'Decoded Input 1, x1 [-]' ), ylabel( 'Decoded Input 2, x2 [-]' ), zlabel( 'Decoded Error, E [-]' ), title( 'RD: Decoded Steady State Error' )
...
legend( { 'Theoretical', 'Numerical' }, 'Location', 'Best', 'Orientation', 'Vertical' )
saveas( fig, [ save_directory, '\', 'relative_division_sse_decoded' ] )

% Create a plot of the encoded theoretical and numerical percentage error. 
fig = figure( 'Color', 'w', 'Name', 'RD: Encoded Steady State Error Percentage' ); hold on, grid on, rotate3d on, view( 135, 30 ), xlabel( 'Encoded Input 1, U1 [mV]' ), ylabel( 'Encoded Input 2, U2 [mV]' ), zlabel( 'Encoded Error Percentage, E [%]' ), title( 'RD: Encoded Steady State Error Percentage' )
...
legend( { 'Theoretical', 'Numerical' }, 'Location', 'Best', 'Orientation', 'Vertical' )
saveas( fig, [ save_directory, '\', 'relative_division_ssep_encoded' ] )

% Create a plot of the decoded theoretical and numerical percentage error.
fig = figure( 'Color', 'w', 'Name', 'RD: Decoded Steady State Error Percentage' ); hold on, grid on, rotate3d on, view( 135, 30 ), xlabel( 'Decoded Input 1, x1 [-]' ), xlabel( 'Decoded Input 2, x2 [-]' ), zlabel( 'Decoded Error Percentage, E [%]' ), title( 'RD: Decoded Steady State Error Percentage' )
...
legend( { 'Theoretical', 'Numerical' }, 'Location', 'Best', 'Orientation', 'Vertical' )
saveas( fig, [ save_directory, '\', 'relative_division_ssep_decoded' ] )
