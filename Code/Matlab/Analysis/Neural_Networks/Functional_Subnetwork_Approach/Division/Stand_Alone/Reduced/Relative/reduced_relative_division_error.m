%% Reduced Relative Division Subnetwork Error.
...
% Compute the desired and achieved reduced relative division steady state output.
U3s_flat_desired_relative = network.compute_desired_reduced_relative_division_steady_state_output( [ U1s_flat, U2s_flat ], c1, c2, R1, R2, R3 );
...
%% Print the Desired Absolute, Desired Relative, and Achieved Reduced Division Formulation Results.
...
%% Plot the Desired Absolute, Desired Relative, and Achieved Reduced Division Formulation Results.
...
fig = figure( 'Color', 'w', 'Name', 'Reduced Relative Division RK4 Maximum Timestep' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage 1 (Input), U1 [mV]' ), ylabel( 'Membrane Voltage 2 (Input), U2 [mV]' ), zlabel( 'Rk4 Maximum Timestep, dt [s]' ), title( 'Reduced Relative Division RK4 Maximum Timestep' )
surf( U1s_grid, U2s_grid, dts_grid, 'EdgeColor', 'None' )
saveas( fig, [ save_directory, '\', 'reduced_relative_division_rk4_maximum_timestep' ] )

% Plot the linearized system condition numbers.
fig = figure( 'Color', 'w', 'Name', 'Reduced Relative Division Condition Numbers' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage 1 (Input), U1 [mV]' ), ylabel( 'Membrane Voltage 2 (Input), U2 [mV]' ), zlabel( 'Condition Number [-]' ), title( 'Reduced Relative Division Condition Number' )
surf( U1s_grid, U2s_grid, condition_numbers_grid, 'EdgeColor', 'None' )
saveas( fig, [ save_directory, '\', 'reduced_relative_division_condition_numbers' ] )
...
if b_simulate               % If we want to simulate the network....
    ...
    save( [ save_directory, '\', 'reduced_relative_division_subnetwork_error' ], 'Applied_Currents1', 'Applied_Currents2', 'Us_achieved' )
    
else                                                        % Otherwise... (We must want to load data from an existing simulation...)
    
    % Load the simulation results.
    data = load( [ load_directory, '\', 'reduced_relative_division_subnetwork_error' ] );
...
Us_desired_output =  c1*R2*R3*Us_achieved( :, :, 1 )./( R1*Us_achieved( :, :, 2 ) + R1*R2*c2 );
...
fig = figure( 'Color', 'w', 'Name', 'Reduced Relative Division Subnetwork Steady State Response (Desired)' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [V]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [V]' ), zlabel( 'Membrane Voltage of Output Neuron, U3 [V]' ), title( 'Reduced Relative Division Subnetwork Steady State Response (Desired)' )
surf( Us_desired( :, :, 1 ), Us_desired( :, :, 2 ), Us_desired( :, :, end ), 'EdgeColor', 'None' )
saveas( fig, [ save_directory, '\', 'reduced_relative_division_ss_response_desired' ] )

% Create a surface that shows the achieved membrane voltage output.
figure( 'Color', 'w', 'Name', 'Reduced Relative Division Subnetwork Steady State Response (Achieved)' ), hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [V]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [V]' ), zlabel( 'Membrane Voltage of Output Neuron, U3 [V]' ), title( 'Reduced Relative Division Subnetwork Steady State Response (Achieved)' )
surf( Us_achieved( :, :, 1 ), Us_achieved( :, :, 2 ), Us_achieved( :, :, end ), 'EdgeColor', 'None' )
saveas( fig, [ save_directory, '\', 'reduced_relative_division_ss_response_achieved' ] )

% Create a figure that shows the differences between the achieved and desired membrane voltage outputs.
figure( 'Color', 'w', 'Name', 'Reduced Relative Division Subnetwork Steady State Response (Comparison)' ), hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [V]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [V]' ), zlabel( 'Membrane Voltage of Output Neuron, U3 [V]' ), title( 'Reduced Relative Division Subnetwork Steady State Response (Comparison)' )
...
saveas( fig, [ save_directory, '\', 'reduced_relative_division_ss_response_comparison' ] )

% Create a surface that shows the membrane voltage error.
figure( 'Color', 'w', 'Name', 'Reduced Relative Division Subnetwork Steady State Error' ), hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [V]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [V]' ), zlabel( 'Membrane Voltage Error, E [V]' ), title( 'Reduced Relative Division Subnetwork Steady State Error' )
surf( Us_achieved( :, :, 1 ), Us_achieved( :, :, 2 ), error, 'EdgeColor', 'None' )
saveas( fig, [ save_directory, '\', 'reduced_relative_division_ss_response_error' ] )
