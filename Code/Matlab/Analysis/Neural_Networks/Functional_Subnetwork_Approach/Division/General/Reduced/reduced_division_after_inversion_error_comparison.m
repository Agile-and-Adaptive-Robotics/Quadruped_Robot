%% Reduced Division After Inversion Subnetwork Error Comparison.
...
c1_absolute = ( ( delta1_absolute - R2_absolute )*delta2_absolute*R3_target_absolute )/( ( delta2_absolute - R3_target_absolute )*R1_absolute );	% [V] Absolute Division Parameter 1.
...
%% Load the Absolute & Relative Reduced Division After Inversion Subnetworks.

% Load the simulation results.
absolute_division_simulation_data = load( [ load_directory, '\', 'reduced_absolute_division_after_inversion_subnetwork_error' ] );
relative_division_simulation_data = load( [ load_directory, '\', 'reduced_relative_division_after_inversion_subnetwork_error' ] );
...
%% Compute the Error in the Steady State Reduced Division After Inversion Subnetwork Responses.
...
%% Print Out the Reduced Division After Inversion Error Summary Information.
...
%% Plot the Steady State Reduced Division After Inversion Error Surfaces.
...
fig = figure( 'color', 'w' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [mV]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [mV]' ), zlabel( 'Membrane Voltage of Output Neuron, U3 [mV]' ), title( 'Reduced Absolute Division After Inversion Subnetwork Steady State Response (Comparison)' )
...
% colorbar(  )
saveas( fig, [ save_directory, '\', 'reduced_absolute_division_after_inversion_ss_response.png' ] )
...
fig = figure( 'color', 'w' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [mV]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [mV]' ), zlabel( 'Membrane Voltage of Output Neuron, U3 [mV]' ), title( 'Reduced Relative Division After Inversion Subnetwork Steady State Response (Comparison)' )
...
% colormap( get_bichromatic_colormap(  ) )
% colorbar(  )
saveas( fig, [ save_directory, '\', 'reduced_relative_division_after_inversion_ss_response.png' ] )

% fig = figure( 'color', 'w' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [mV]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [mV]' ), zlabel( 'Membrane Voltage of Output Neuron, U3 [mV]' ), title( 'Reduced Division Subnetwork Ater Inversion Steady State Response (Comparison)' )
...
view( -45, 15 )
% colormap( get_bichromatic_colormap(  ) )
saveas( fig, [ save_directory, '\', 'reduced_division_after_inversion_ss_response_comparison.png' ] )

% Create a surface that shows the membrane voltage error.
fig = figure( 'color', 'w' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [mV]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [mV]' ), zlabel( 'Membrane Voltage Error, E [mV]' ), title( 'Reduced Division After Inversion Subnetwork Steady State Error' )
...
% colormap( get_bichromatic_colormap(  ) )
% colorbar(  )
saveas( fig, [ save_directory, '\', 'reduced_division_after_inversion_approximation_error_comparison.png' ] )

% Create a surface that shows the membrane voltage error percentage.
fig = figure( 'color', 'w' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [mV]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [mV]' ), zlabel( 'Membrane Voltage Error Percentage, E [%]' ), title( 'Reduced Division After Inversion Subnetwork Steady State Error Percentage' )
...
% colormap( get_bichromatic_colormap(  ) )
% colorbar(  )
saveas( fig, [ save_directory, '\', 'reduced_division_after_inversion_approximation_error_percentage_comparison.png' ] )

% Create a surface that shows the difference in error between the absolute and relative division subnetworks.
fig = figure( 'color', 'w' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [mV]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [mV]' ), zlabel( 'Membrane Voltage Error Difference, dE [mV]' ), title( 'Reduced Division After Inversion Steady State Error Difference' )
surf( Us_achieved_absolute( :, :, 1 )*(10^3), Us_achieved_absolute( :, :, 2 )*(10^3), error_difference*(10^3), 'Edgecolor', 'Interp', 'Facecolor', 'Interp' )
view( 45, 15 )
% colormap( get_bichromatic_colormap(  ) )
% colorbar(  )
saveas( fig, [ save_directory, '\', 'reduced_division_after_inversion_approximation_error_difference.png' ] )

% Create a surface that shows the difference in error between the absolute and relative percent division subnetworks.
% fig = figure( 'color', 'w' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [mV]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [mV]' ), zlabel( 'Membrane Voltage Error Difference Percentage, dE [%]' ), title( 'Reduced Division After Inversion Subnetwork Steady State Error Percentage Difference' )
fig = figure( 'color', 'w' ); hold on, grid on, rotate3d on
...
% colormap( get_bichromatic_colormap(  ) )
% colorbar(  )
saveas( fig, [ save_directory, '\', 'reduced_division_after_inversion_approximation_error_percentage_difference.png' ] )
