%% Absolute Division Subnetwork Derivation
...
dc_sol = solve( [ dc1, dc2, dc3, dc4 ], [ R3, c2 ] );
...
% Substitute known values into desired and acheived formulation solution results.
gs31 = subs( gs31, 'R3', R3 );
gs32 = subs( gs32, 'R3', R3 );
