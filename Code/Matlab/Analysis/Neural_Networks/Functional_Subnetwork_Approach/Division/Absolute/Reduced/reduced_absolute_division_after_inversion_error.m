%% Reduced Absolute Division After Inversion Subnetwork Error.
...
%% Define Basic Reduced Absolute Division After Inversion Subnetwork Parameters.
...
c1 = ( ( delta1 - R2 )*delta2*R3_target )/( ( delta2 - R3_target )*R1 );      	% [V] Absolute Division Parameter 1.


%% Compute Reduced Absolute Division After Inversion Subnetwork Derived Parameters.

% Compute the network design parameters.
c2 = ( R1*c1 - delta2*R2 )/( delta2 );                                                                              % [A] Absolute Division Parameter 2.

% Compute the maximum membrane voltages.
R3 = ( R1*c1 )/( delta1 + c2 );                                                                                     % [V] Maximum Membrane Voltage (Neuron 3).
...
%% Print Reduced Absolute Division After Inversion Subnetwork Parameters.
...
%% Create a Reduced Absolute Division After Inversion Subnetwork.
...
%% Compute Desired & Achieved Reduced Absolute Division After Inversion Formulations.
...
U3s_flat_desired_absolute = network.compute_desired_reduced_absolute_division_steady_state_output( [ U1s_flat, U2s_flat ], c1, c2 );
...
%% Print the Desired Absolute, Desired Relative, and Achieved Reduced Division After Inversion Formulation Results.
...
%% Plot the Desired Absolute, Desired Relative, and Achieved Reduced Division After Inversion Formulation Results.

% Plot the desired and achieved absolute division formulation results.
fig = figure( 'Color', 'w', 'Name', 'Reduced Absolute Division After Inversion Theory' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage 1 (Input), U1 [mV]' ), ylabel( 'Membrane Voltage 2 (Input), U2 [mV]' ), zlabel( 'Membrane Voltage 3 (Output), U3 [mV]' ), title( 'Reduced Absolute Division After Inversion Theory' )
...
saveas( fig, [ save_directory, '\', 'reduced_absolute_division_after_inversion_theory' ] )

% Plot the RK4 maximum timestep.
fig = figure( 'Color', 'w', 'Name', 'Reduced Absolute Division After Inversion RK4 Maximum Timestep' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage 1 (Input), U1 [mV]' ), ylabel( 'Membrane Voltage 2 (Input), U2 [mV]' ), zlabel( 'Rk4 Maximum Timestep, dt [s]' ), title( 'Reduced Absolute Division After Inversion RK4 Maximum Timestep' )
surf( U1s_grid, U2s_grid, dts_grid, 'EdgeColor', 'None' )
saveas( fig, [ save_directory, '\', 'reduced_absolute_division_after_inversion_rk4_maximum_timestep' ] )

% Plot the linearized system condition numbers.
fig = figure( 'Color', 'w', 'Name', 'Reduced Absolute Division After Inversion Condition Numbers' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage 1 (Input), U1 [mV]' ), ylabel( 'Membrane Voltage 2 (Input), U2 [mV]' ), zlabel( 'Condition Number [-]' ), title( 'Reduced Absolute Division After Inversion Condition Number' )
surf( U1s_grid, U2s_grid, condition_numbers_grid, 'EdgeColor', 'None' )
saveas( fig, [ save_directory, '\', 'reduced_absolute_division_after_inversion_condition_numbers' ] )


%% Simulate the Reduced Absolute Division After Inversion Subnetwork.
...
%     applied_currents2 = linspace( 0, network.neuron_manager.neurons( 2 ).R*network.neuron_manager.neurons( 2 ).Gm, n_applied_currents2 );
    ...
    save( [ save_directory, '\', 'reduced_absolute_division_after_inversion_subnetwork_error' ], 'Applied_Currents1', 'Applied_Currents2', 'Us_achieved' )
    
else                                                        % Otherwise... (We must want to load data from an existing simulation...)
    
    % Load the simulation results.
    data = load( [ load_directory, '\', 'absolute_division_after_inversion_subnetwork_error' ] );
...
%% Compute the Reduced Absolute Division Subnetwork Error.

% Compute the desired membrane voltage output.
Us_desired_output =  c1*Us_achieved( :, :, 1 )./( Us_achieved( :, :, 2 ) + c2 );
...
%% Plot the Reduced Absolute Division After Inversion Subnetwork Results.

% Create a surface that shows the desired membrane voltage output.
fig = figure( 'Color', 'w', 'Name', 'Reduced Absolute Division After Inversion Subnetwork Steady State Response (Desired)' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [V]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [V]' ), zlabel( 'Membrane Voltage of Output Neuron, U3 [V]' ), title( 'Reduced Absolute Division After Inversion Subnetwork Steady State Response (Desired)' )
surf( Us_desired( :, :, 1 ), Us_desired( :, :, 2 ), Us_desired( :, :, end ), 'EdgeColor', 'None' )
saveas( fig, [ save_directory, '\', 'reduced_absolute_division_after_inversion_ss_response_desired' ] )

% Create a surface that shows the achieved membrane voltage output.
fig = figure( 'Color', 'w', 'Name', 'Reduced Absolute Division After Inversion Subnetwork Steady State Response (Achieved)' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [V]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [V]' ), zlabel( 'Membrane Voltage of Output Neuron, U3 [V]' ), title( 'Reduced Absolute Division After Inversion Subnetwork Steady State Response (Achieved)' )
surf( Us_achieved( :, :, 1 ), Us_achieved( :, :, 2 ), Us_achieved( :, :, end ), 'EdgeColor', 'None' )
saveas( fig, [ save_directory, '\', 'reduced_absolute_division_after_inversion_ss_response_achieved' ] )

% Create a figure that shows the differences between the achieved and desired membrane voltage outputs.
fig = figure( 'Color', 'w', 'Name', 'Reduced Absolute Division After Inversion Subnetwork Steady State Response (Comparison)' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [V]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [V]' ), zlabel( 'Membrane Voltage of Output Neuron, U3 [V]' ), title( 'Reduced Absolute Division After Inversion Subnetwork Steady State Response (Comparison)' )
...
saveas( fig, [ save_directory, '\', 'reduced_absolute_division_after_inversion_ss_response_comparison' ] )

% Create a surface that shows the membrane voltage error.
fig = figure( 'Color', 'w', 'Name', 'Reduced Absolute Division After Inversion Subnetwork Steady State Error' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [V]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [V]' ), zlabel( 'Membrane Voltage Error, E [V]' ), title( 'Reduced Absolute Division After Inversion Subnetwork Steady State Error' )
surf( Us_achieved( :, :, 1 ), Us_achieved( :, :, 2 ), error, 'EdgeColor', 'None' )
saveas( fig, [ save_directory, '\', 'reduced_absolute_division_after_inversion_ss_response_error' ] )
