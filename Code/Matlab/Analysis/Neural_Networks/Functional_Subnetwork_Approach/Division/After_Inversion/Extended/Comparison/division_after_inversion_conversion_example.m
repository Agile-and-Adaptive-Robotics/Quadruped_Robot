%% Division After Inversion Subnetwork Conversion Example.
...
%% Define the Fundamental Parameters of a Relative Division After Inversion Subnetwork.
...
%% Compute the Derived Parameters of a Relative Division After Inversion Subnetwork.
...
delta1_absolute = delta1_relative;                                                                                                                          % [V] Membrane Voltage Offset (Neuron 1).
delta2_absolute = delta2_relative;                                                                                                                          % [V] Membrane Voltage Offset (Neuron 2).
c2_absolute = 1*c2_relative;                                                                                                                                % [A] Design Constant 2.
c3_absolute = ( ( delta2_absolute*R2_absolute - delta1_absolute*R3_absolute )*c2_absolute )/( R3_absolute - delta2_absolute );                              % [W] Design Constant 3.
c1_absolute = ( ( R2_absolute - delta1_absolute )*delta2_absolute*c2_absolute*R3_absolute )/( ( R3_absolute - delta2_absolute )*R1_absolute );              % [W] Design Constant 1.
