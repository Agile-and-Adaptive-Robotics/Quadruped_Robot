%% Reduced Relative Division After Inversion Subnetwork Error.
...
%% Compute Desired & Achieved Reduced Relative Division After Inversion Formulations.
...
U3s_flat_desired_relative = network.compute_desired_reduced_relative_division_steady_state_output( [ U1s_flat, U2s_flat ], c1, c2 );
...
%% Print the Reduced Relative Division After Inversion Numerical Stability Information.
...
%% Plot the Reduced Relative Division After Inversion Formulation Results.

% Plot the desired and achieved relative division formulation results.
fig = figure( 'Color', 'w', 'Name', 'Reduced Relative Division After Inversion Theory' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage 1 (Input), U1 [mV]' ), ylabel( 'Membrane Voltage 2 (Input), U2 [mV]' ), zlabel( 'Membrane Voltage 3 (Output), U3 [mV]' ), title( 'Reduced Relative Division After Inversion Theory' )
...
saveas( fig, [ save_directory, '\', 'reduced_relative_division_after_inversion_theory' ] )

% Plot the RK4 maximum timestep.
fig = figure( 'Color', 'w', 'Name', 'Reduced Relative Division After Inversion RK4 Maximum Timestep' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage 1 (Input), U1 [mV]' ), ylabel( 'Membrane Voltage 2 (Input), U2 [mV]' ), zlabel( 'Rk4 Maximum Timestep, dt [s]' ), title( 'Reduced Relative Division After Inversion RK4 Maximum Timestep' )
surf( U1s_grid, U2s_grid, dts_grid, 'EdgeColor', 'None' )
saveas( fig, [ save_directory, '\', 'reduced_relative_division_after_inversion_rk4_maximum_timestep' ] )

% Plot the linearized system condition numbers.
fig = figure( 'Color', 'w', 'Name', 'Reduced Relative Division After Inversion Condition Numbers' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage 1 (Input), U1 [mV]' ), ylabel( 'Membrane Voltage 2 (Input), U2 [mV]' ), zlabel( 'Condition Number [-]' ), title( 'Reduced Relative Division After Inversion Condition Number' )
surf( U1s_grid, U2s_grid, condition_numbers_grid, 'EdgeColor', 'None' )
saveas( fig, [ save_directory, '\', 'reduced_relative_division_after_inversion_condition_numbers' ] )
...
if b_simulate               % If we want to simulate the network....
    ...
    save( [ save_directory, '\', 'reduced_relative_division_after_inversion_subnetwork_error' ], 'Applied_Currents1', 'Applied_Currents2', 'Us_achieved' )
...
%% Compute the Reduced Relative Division Subnetwork Error.

% Compute the desired membrane voltage output.
Us_desired_output =  c1*R2*R3*Us_achieved( :, :, 1 )./( R1*Us_achieved( :, :, 2 ) + c2*R1*R2 );
...
fig = figure( 'Color', 'w', 'Name', 'Reduced Relative Division After Inversion Subnetwork Steady State Response (Desired)' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [V]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [V]' ), zlabel( 'Membrane Voltage of Output Neuron, U3 [V]' ), title( 'Reduced Relative Division After Inversion Subnetwork Steady State Response (Desired)' )
surf( Us_desired( :, :, 1 ), Us_desired( :, :, 2 ), Us_desired( :, :, end ), 'EdgeColor', 'None' )
saveas( fig, [ save_directory, '\', 'reduced_relative_division_after_inversion_ss_response_desired' ] )

% Create a surface that shows the achieved membrane voltage output.
fig = figure( 'Color', 'w', 'Name', 'Reduced Relative Division After Inversion Subnetwork Steady State Response (Achieved)' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [V]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [V]' ), zlabel( 'Membrane Voltage of Output Neuron, U3 [V]' ), title( 'Reduced Relative Division After Inversion Subnetwork Steady State Response (Achieved)' )
surf( Us_achieved( :, :, 1 ), Us_achieved( :, :, 2 ), Us_achieved( :, :, end ), 'EdgeColor', 'None' )
saveas( fig, [ save_directory, '\', 'reduced_relative_division_after_inversion_ss_response_achieved' ] )

% Create a figure that shows the differences between the achieved and desired membrane voltage outputs.
fig = figure( 'Color', 'w', 'Name', 'Reduced Relative Division After Inversion Subnetwork Steady State Response (Comparison)' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [V]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [V]' ), zlabel( 'Membrane Voltage of Output Neuron, U3 [V]' ), title( 'Reduced Relative Division After Inversion Subnetwork Steady State Response (Comparison)' )
...
saveas( fig, [ save_directory, '\', 'reduced_relative_division_after_inversion_ss_response_comparison' ] )

% Create a surface that shows the membrane voltage error.
fig = figure( 'Color', 'w', 'Name', 'Reduced Relative Division After Inversion Subnetwork Steady State Error' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [V]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [V]' ), zlabel( 'Membrane Voltage Error, E [V]' ), title( 'Reduced Relative Division After Inversion Subnetwork Steady State Error' )
surf( Us_achieved( :, :, 1 ), Us_achieved( :, :, 2 ), error, 'EdgeColor', 'None' )
saveas( fig, [ save_directory, '\', 'reduced_relative_division_after_inversion_ss_response_error' ] )
