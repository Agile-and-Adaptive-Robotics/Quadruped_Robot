...
%% Simulate the Relative Multiplication Subnetwork.
...
if b_simulate               % If we want to simulate the network....
    ...
    save( [ save_directory, '\', 'relative_multiplication_error' ], 'Applied_Currents1', 'Applied_Currents2', 'Us_achieved' )
    
else                % Otherwise... (We must want to load data from an existing simulation...)
    
    % Load the simulation results.
    data = load( [ load_directory, '\', 'relative_multiplication_error' ] );
...
fig = figure( 'Color', 'w', 'Name', 'Relative Multiplication Steady State Response (Comparison)' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [V]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [V]' ), zlabel( 'Membrane Voltage of Output Neuron, U3 [V]' ), title( 'Relative Multiplication Steady State Response (Comparison)' )
...
fig = figure( 'Color', 'w', 'Name', 'Relative Multiplication Steady State Error' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [V]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [V]' ), zlabel( 'Membrane Voltage Error, E [V]' ), title( 'Relative Multiplication Subnetwork Steady State Error' )
