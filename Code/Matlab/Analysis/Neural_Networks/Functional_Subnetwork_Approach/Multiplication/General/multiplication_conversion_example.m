%% Multiplication Subnetwork Conversion Example.
...
c2_absolute = 1*c2_relative;                                                                                                                                % [S] Multiplication Design Constant 2 (Inversion Design Constant 2).
c1_absolute =( delta1_absolute*R1_absolute*R2_relative*c2_absolute )/( R2_relative - delta1_absolute );                                                       % [W] Multiplication Design Constant 1 (Inversion Design Constant 1).
c3_absolute = ( delta1_absolute*R1_absolute*c2_absolute )/( R2_relative - delta1_absolute );                                                                  % [A] Multiplication Design Constant 3 (Inversino Design Constant 3).

c5_absolute = 1*c5_relative;                                                                                                                                % [A] Multiplication Design Constant 5 (Division After Inversion Design Constant 2).
c6_absolute = ( ( delta2_absolute*R3_absolute - delta1_absolute*R4_absolute )*c5_absolute )/( R4_absolute - delta2_absolute );                              % [W] Multiplication Design Constant 6 (Division After Inversion Design Constant 3).
c4_absolute = ( ( R3_absolute - delta1_absolute )*delta2_absolute*c5_absolute*R4_absolute )/( ( R4_absolute - delta2_absolute )*R1_absolute );              % [W] Multiplication Design Constant 4 (Division After Inversion Design Constant 1).
...
c5_absolute = ( R1_absolute*c4_absolute - delta2_absolute*c6_absolute )/( delta2_absolute*R3_absolute );                                                                                                                                             	% [A] Absolute Multiplication Parameter 5 (Absolute Division After Inversion Parameter 2).
