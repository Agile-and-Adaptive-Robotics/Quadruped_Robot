...
c6_absolute = 1e-9;                                                                                                      % [W] Absolute Multiplication Parameter 6 (Absolute Division After Inversion Parameter 3).
c4_absolute = ( ( R3_target_absolute - delta1_absolute )*c6_absolute*R4_target_absolute*delta2_absolute )/( ( R3_target_absolute*delta2_absolute - R4_target_absolute*delta1_absolute )*R1_absolute );             % [W] Absolute Multiplication Parameter 4 (Absolute Division After Inversion Parameter 1).
c3_absolute = 20e-9;                                                                                                     % [A] Absolute Multiplication Parameter 3 (Absolute Inversion Parameter 3).
c1_absolute = R3_target_absolute*c3_absolute;                                                                                              % [W] Absolute Multiplication Parameter 1 (Absolute Inversion Parameter 1).


%% Compute Derived Absolute Mutliplication Subnetwork Constraints.

% Compute the network design parameters.
c2_absolute = ( c1_absolute - delta1_absolute*c3_absolute )/( delta1_absolute*R1_absolute );                                                                       	% [S] Absolute Multiplication Parameter 2 (Absolute Inversion Parameter 2).
c5_absolute = ( R1_absolute*c4_absolute - delta2_absolute*c6_absolute )/( delta2_absolute*R3_target_absolute );                                                            	% [A] Absolute Multiplication Parameter 5 (Absolute Division After Inversion Parameter 2).

% Compute the maximum membrane voltages.
R3_absolute = c1_absolute/c3_absolute;
R4_absolute = ( R1_absolute*c4_absolute )/( delta1_absolute*c5_absolute + c6_absolute );                                                                              % [V] Maximum Membrane Voltage (Neuron 4).

% Compute the synaptic conductances.
gs32_absolute = ( delta1_absolute*Gm3_absolute - Ia3_absolute )/( dEs32_absolute - delta1_absolute );                                                                 % [S] Synaptic Conductance (Synapse 32).
...
% Define subnetwork design constants.
c3_relative = 1e-6;                                                                                                      % [-] Relative Multiplication Parameter 3 (Relative Inversion Parameter 3).
c6_relative = 1e-6;                                                                                                      % [S] Relative Multiplication Parameter 6 (Relative Division After Inversion Parameter 3).


%% Compute Derived Relative Multiplication Subnetwork Parameters.

% Compute the network design parameters.
c1_relative = c3_relative;                                                                                                        % [-] Relative Multiplication Parameter 1 (Relative Inversion Parameter 1).
c2_relative = ( ( R3_relative - delta1_relative )*c3_relative )/( delta1_relative );                                                                         % [-] Relative Multiplication Parameter 2 (Relative Inversion Parameter 2).
c4_relative = ( ( R3_relative - delta1_relative )*c6_relative*delta2_relative )/( R3_relative*delta2_relative - R4_relative*delta1_relative );                                               	% [S] Relative Multiplication Parameter 4 (Relative Division After Inversion Parameter 1).
c5_relative = ( ( R4_relative - delta2_relative )*c6_relative*R3_relative )/( R3_relative*delta2_relative - R4_relative*delta1_relative );                                                   	% [S] Relative Multiplication Parameter 5 (Relative Division After Inversion Parameter 2).

% Compute the synaptic conductances.
gs32_relative = ( ( R3_relative - delta1_relative )*c3_relative )/( delta1_relative );                                                                       % [S] Synaptic Conductance (Synapse 32).
gs41_relative = ( ( delta1_relative - R3_relative )*delta2_relative*R4_relative*Gm4_relative )/( ( R3_relative - delta1_relative )*delta2_relative*R4_relative + ( R4_relative*delta1_relative - R3_relative*delta2_relative )*dEs41_relative );       % [S] Maximum Synaptic Conductance (Synapse 41).
gs43_relative = ( ( delta2_relative - R4_relative )*dEs41_relative*R3_relative*Gm4_relative )/( ( R3_relative - delta1_relative )*delta2_relative*R4_relative + ( R4_relative*delta1_relative - R3_relative*delta2_relative )*dEs41_relative );        % [S] Maximum Synaptic Conductance (Synapse 43).
...
absolute_multiplication_simulation_data = load( [ load_directory, '\', 'absolute_multiplication_error' ] );
relative_multiplication_simulation_data = load( [ load_directory, '\', 'relative_multiplication_error' ] );
...
fig = figure( 'color', 'w' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [mV]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [mV]' ), zlabel( 'Membrane Voltage of Output Neuron, U3 [mV]' ), title( 'Absolute Multiplication Steady State Response (Comparison)' )
...
% colorbar(  )
saveas( fig, [ save_directory, '\', 'absolute_multiplication_ss_response.png' ] )
...
fig = figure( 'color', 'w' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [mV]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [mV]' ), zlabel( 'Membrane Voltage of Output Neuron, U3 [mV]' ), title( 'Relative Multiplication Steady State Response (Comparison)' )
...
% colormap( get_bichromatic_colormap(  ) )
% colorbar(  )
saveas( fig, [ save_directory, '\', 'relative_multiplication_ss_response.png' ] )

% Create a figure that shows the differences between the achieved and desired membrane voltage outputs for the relative multiplication subnetwork.
fig = figure( 'color', 'w' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [mV]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [mV]' ), zlabel( 'Membrane Voltage of Output Neuron, U3 [mV]' ), title( 'Multiplication Steady State Response (Comparison)' )
...
% colormap( get_bichromatic_colormap(  ) )
% colorbar(  )
saveas( fig, [ save_directory, '\', 'multiplication_ss_response.png' ] )


% Create a surface that shows the membrane voltage error.
fig = figure( 'color', 'w' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [mV]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [mV]' ), zlabel( 'Membrane Voltage Error, E [mV]' ), title( 'Multiplication Steady State Error' )
...
% colormap( get_bichromatic_colormap(  ) )
% colorbar(  )
saveas( fig, [ save_directory, '\', 'multiplication_error_comparison.png' ] )

% Create a surface that shows the membrane voltage error percentage.
fig = figure( 'color', 'w' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [mV]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [mV]' ), zlabel( 'Membrane Voltage Error Percentage, E [%]' ), title( 'Multiplication Steady State Error Percentage' )
...
% colormap( get_bichromatic_colormap(  ) )
% colorbar(  )
saveas( fig, [ save_directory, '\', 'multiplication_error_percentage_comparison.png' ] )

% Create a surface that shows the difference in error between the absolute and relative multiplication subnetworks.
fig = figure( 'color', 'w' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [mV]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [mV]' ), zlabel( 'Membrane Voltage Error Difference, dE [mV]' ), title( 'Multiplication Steady State Error Difference' )
surf( Us_achieved_absolute( :, :, 1 )*(10^3), Us_achieved_absolute( :, :, 2 )*(10^3), error_difference*(10^3), 'Edgecolor', 'Interp', 'Facecolor', 'Interp' )
view( 45, 15 )
% colormap( get_bichromatic_colormap(  ) )
% colorbar(  )
saveas( fig, [ save_directory, '\', 'multiplication_error_difference.png' ] )

% Create a surface that shows the difference in error between the absolute and relative percent multiplication subnetworks.
fig = figure( 'color', 'w' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [mV]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [mV]' ), zlabel( 'Membrane Voltage Error Difference Percentage, dE [%]' ), title( 'Multiplication Steady State Error Percentage Difference' )
% fig = figure( 'color', 'w' ); hold on, grid on, rotate3d on
...
% colormap( get_bichromatic_colormap(  ) )
% colorbar(  )
saveas( fig, [ save_directory, '\', 'multiplication_error_percentage_difference.png' ] )
