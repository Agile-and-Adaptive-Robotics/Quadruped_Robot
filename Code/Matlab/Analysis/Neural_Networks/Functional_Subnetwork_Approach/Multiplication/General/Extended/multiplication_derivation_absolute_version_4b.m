%% Absolute Multiplication (Version 4b) Functional Subnetwork Design Rule Derivation
...
fprintf( 'ABSOLUTE MULTIPLICATION: VERSION 4B\n' )
...
U4_achieved = ( R3*gs42*dEs42*U2 + R2*gs43*dEs43*U3 + R2*R3*Ia4 )/( R3*gs42*U2 + R2*gs43*U3 + R2*R3*Gm4 );
...
eq_similarity = U4_desired*U4_achieved_den - U4_achieved_num;
