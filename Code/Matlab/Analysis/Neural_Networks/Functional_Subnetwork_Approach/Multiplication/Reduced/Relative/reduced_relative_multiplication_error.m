%% Reduced Relative Multiplication Subnetwork Error.
...
c1 = delta1/( R2 - delta1 );                                                                                     % [-] Reduced Relative Multiplication Design Constant 1 (Reduced Relative Inversion Design Constant 1).
c2 = c1;                                                                                                        % [-] Reduced Relative Multiplication Design Constant 2 (Reduced Relative Inversion Design Constant 2).
c3 = ( ( R3 - delta1 )*delta2 )/( ( R4 - delta2 )*R3 );                                                     	% [-] Reduced Relative Multiplication Design Constant 3 (Reduced Relative Division After Inversion Design Constant 1).
c4 = ( delta2*R3 - delta1*R4 )/( ( R4 - delta2 )*R3 );                                                        	% [-] Reduced Relative Multiplication Design Constant 4 (Reduced Relative Division AFter Inversion Design Constant 2).

% Compute the synaptic conductances.
gs32 = ( Ia3 - delta1*Gm3 )/( delta1 - dEs32 );                                                                 % [S] Synaptic Conductance (Synapse 32).
gs41 = ( ( delta1 - R3 )*delta2*R4*Gm4 )/( ( R3 - delta1 )*delta2*R4 + ( delta1*R4 - delta2*R3 )*dEs41 );       % [S] Synaptic Conductance (Synapse 41).
gs43 = ( ( delta2 - R4 )*R3*Gm4*dEs41 )/( ( R3 - delta1 )*delta2*R4 + ( delta1*R4 - delta2*R3 )*dEs41 );        % [S] Synaptic Conductance (Synapse 43).
...
%% Create a Reduced Relative Multiplication Subnetwork.
...
[ U4s_flat_desired_relative, U3s_flat_desired_relative ] = network.compute_desired_red_rel_mult_ss_output( [ U1s_flat, U2s_flat ], c1, c2, c3, c4 );
...
%% Print the Desired Relative, Desired Relative, and Achieved Reduced Multiplication Formulation Results.
...
%% Plot the Desired Relative, Desired Relative, and Achieved Reduced Multiplication Formulation Results.

% Plot the desired and achieved relative inversion formulation results.
fig = figure( 'Color', 'w', 'Name', 'Reduced Relative Inversion Theory' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage 1 (Input), U1 [mV]' ), ylabel( 'Membrane Voltage 2 (Input), U2 [mV]' ), zlabel( 'Membrane Voltage 3 (Output), U3 [mV]' ), title( 'Reduced Relative Inversion Theory' )
...
fig = figure( 'Color', 'w', 'Name', 'Reduced Relative Division Theory' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage 1 (Input), U1 [mV]' ), ylabel( 'Membrane Voltage 2 (Input), U2 [mV]' ), zlabel( 'Membrane Voltage 3 (Output), U3 [mV]' ), title( 'Reduced Relative Division Theory' )
...
legend( 'Desired', 'Achieved' )
saveas( fig, [ save_directory, '\', 'reduced_relative_division_theory' ] )

% Plot the desired and achieved relative multiplication formulation results.
fig = figure( 'Color', 'w', 'Name', 'Reduced Relative Multiplication Theory' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage 1 (Input), U1 [mV]' ), ylabel( 'Membrane Voltage 2 (Input), U2 [mV]' ), zlabel( 'Membrane Voltage 3 (Output), U3 [mV]' ), title( 'Reduced Relative Multiplication Theory' )
...
legend( 'Desired', 'Achieved' )
saveas( fig, [ save_directory, '\', 'reduced_relative_multiplication_theory' ] )

% Plot the RK4 maximum timestep.
fig = figure( 'Color', 'w', 'Name', 'Reduced Relative Multiplication RK4 Maximum Timestep' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage 1 (Input), U1 [mV]' ), ylabel( 'Membrane Voltage 2 (Input), U2 [mV]' ), zlabel( 'Rk4 Maximum Timestep, dt [s]' ), title( 'Reduced Relative Multiplication RK4 Maximum Timestep' )
surf( U1s_grid, U2s_grid, dts_grid, 'Edgecolor', 'None' )
saveas( fig, [ save_directory, '\', 'reduced_relative_multiplication_rk4_maximum_timestep' ] )

% Plot the linearized system condition numbers.
fig = figure( 'Color', 'w', 'Name', 'Reduced Relative Multiplication Condition Numbers' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage 1 (Input), U1 [mV]' ), ylabel( 'Membrane Voltage 2 (Input), U2 [mV]' ), zlabel( 'Condition Number [-]' ), title( 'Reduced Relative Multiplication Condition Number' )
...
%% Simulate the Reduced Relative Multiplication Subnetwork.
...
if b_simulate               % If we want to simulate the network....
    ...
    save( [ save_directory, '\', 'reduced_relative_multiplication_error' ], 'Applied_Currents1', 'Applied_Currents2', 'Us_achieved' )
    
else                % Otherwise... (We must want to load data from an existing simulation...)
    
    % Load the simulation results.
    data = load( [ load_directory, '\', 'reduced_relative_multiplication_error' ] );
...
%% Compute the Reduced Relative Multiplication Subnetwork Error.
...
Us_desired_output =  ( c3*R3*R4*Us_achieved( :, :, 1 ).*Us_achieved( :, :, 2 ) + c2*c3*R2*R3*R4*Us_achieved( :, :, 1 ) )./( c4*R1*R3*Us_achieved( :, :, 2 ) + ( c2*c4 + c1 )*R1*R2*R3 );
...
%% Plot the Reduced Relative Multiplication Subnetwork Results.

% Create a surface that shows the desired membrane voltage output.
fig = figure( 'Color', 'w', 'Name', 'Reduced Relative Multiplication Steady State Response (Desired)' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [V]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [V]' ), zlabel( 'Membrane Voltage of Output Neuron, U3 [V]' ), title( 'Reduced Relative Multiplication Steady State Response (Desired)' )
surf( Us_desired( :, :, 1 ), Us_desired( :, :, 2 ), Us_desired( :, :, end ), 'Edgecolor', 'None' )
saveas( fig, [ save_directory, '\', 'reduced_relative_multiplication_ss_response_desired' ] )

% Create a surface that shows the achieved membrane voltage output.
fig = figure( 'Color', 'w', 'Name', 'Reduced Relative Multiplication Steady State Response (Achieved)' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [V]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [V]' ), zlabel( 'Membrane Voltage of Output Neuron, U3 [V]' ), title( 'Reduced Relative Multiplication Steady State Response (Achieved)' )
surf( Us_achieved( :, :, 1 ), Us_achieved( :, :, 2 ), Us_achieved( :, :, end ), 'Edgecolor', 'None' )
saveas( fig, [ save_directory, '\', 'reduced_relative_multiplication_ss_response_achieved' ] )

% Create a figure that shows the differences between the achieved and desired membrane voltage outputs.
fig = figure( 'Color', 'w', 'Name', 'Reduced Relative Multiplication Steady State Response (Comparison)' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [V]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [V]' ), zlabel( 'Membrane Voltage of Output Neuron, U3 [V]' ), title( 'Reduced Relative Multiplication Steady State Response (Comparison)' )
...
saveas( fig, [ save_directory, '\', 'reduced_relative_multiplication_ss_response_comparison' ] )

% Create a surface that shows the membrane voltage error.
fig = figure( 'Color', 'w', 'Name', 'Reduced Relative Multiplication Steady State Error' ); hold on, grid on, rotate3d on, xlabel( 'Membrane Voltage of First Input Neuron, U1 [V]' ), ylabel( 'Membrane Voltage of Second Input Neuron, U2 [V]' ), zlabel( 'Membrane Voltage Error, E [V]' ), title( 'Reduced Relative Multiplication Steady State Error' )
surf( Us_achieved( :, :, 1 ), Us_achieved( :, :, 2 ), error, 'Edgecolor', 'None' )
saveas( fig, [ save_directory, '\', 'reduced_relative_multiplication_ss_response_error' ] )
