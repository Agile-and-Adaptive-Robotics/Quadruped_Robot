...
current_state1_absolute = 1;                                 % [-] Current State (Neuron 1). (Specified as a ratio of the total applied current that is active.)
...
% Define the current state.
current_state1_relative = 0.5;                                 % [-] Current State (Neuron 1). (Specified as a ratio of the total applied current that is active.)
...
fprintf( 'Absolute Transmission Summary Statistics\n' )
...
fprintf( '\n' )
fprintf( 'Relative Transmission Summary Statistics\n' )
...
fprintf( '\n' )
fprintf( 'Absolute vs Relative Transmission Summary Statistics:\n' )
...
% Create a figure that shows the differences between the achieved and desired membrane voltage outputs for the absolute transmission subnetwork.
fig = figure( 'color', 'w' ); hold on, grid on, xlabel( 'Membrane Voltage of Input Neuron, U1 [mV]' ), ylabel( 'Membrane Voltage of Output Neuron, U2 [mV]' ), title( 'Absolute Transmission Subnetwork Steady State Response (Comparison)' )
...
saveas( fig, [ save_directory, '\', 'Absolute_Transmission_Subnetwork_Steady_State_Response.png' ] )
...
fig = figure( 'color', 'w' ); hold on, grid on, xlabel( 'Membrane Voltage of Input Neuron, U1 [mV]' ), ylabel( 'Membrane Voltage of Output Neuron, U2 [mV]' ), title( 'Relative Transmission Subnetwork Steady State Response (Comparison)' )
...
legend( { 'Desired', 'Achieved' }, 'Location', 'Bestoutside', 'Orientation', 'Horizontal' )
saveas( fig, [ save_directory, '\', 'Relative_Transmission_Subnetwork_Steady_State_Response.png' ] )

% Create a figure that shows the differences between the achieved and desired membrane voltage outputs for the relative transmission subnetwork.
% fig = figure( 'color', 'w' ); hold on, grid on, xlabel( 'Membrane Voltage of Input Neuron, U1 [mV]' ), ylabel( 'Membrane Voltage of Output Neuron, U2 [mV]' ), title( 'Transmission Subnetwork Steady State Response (Comparison)' )
...
fig = figure( 'color', 'w' ); hold on, grid on, xlabel( 'Membrane Voltage of Input Neuron, U1 [mV]' ), ylabel( 'Membrane Voltage Error, E [mV]' ), title( 'Transmission Subnetwork Steady State Error' )
...
saveas( fig, [ save_directory, '\', 'Transmission_Subnetwork_Approximation_Error_Comparison.png' ] )

% Create a surface that shows the membrane voltage error percentage.
fig = figure( 'color', 'w' ); hold on, grid on, xlabel( 'Membrane Voltage of Input Neuron, U1 [mV]' ), ylabel( 'Membrane Voltage Error Percentage, E [%]' ), title( 'Transmission Subnetwork Steady State Error Percentage' )
...
fig = figure( 'color', 'w' ); hold on, grid on, xlabel( 'Membrane Voltage of Input Neuron, U1 [mV]' ), ylabel( 'Membrane Voltage Error Difference, dE [mV]' ), title( 'Transmission Subnetwork Steady State Error Difference' )
plot( Us_achieved_absolute( :, 1 )*(10^3), error_difference*(10^3), '-', 'Linewidth', 3 )
saveas( fig, [ save_directory, '\', 'Transmission_Subnetwork_Approximation_Error_Difference.png' ] )
