...
% Define the subnetwork design params.
...
% Store the subnetwork design params in a structure.
reduced_absolute_inversion_input_params.c1 = c1;
reduced_absolute_inversion_input_params.delta = delta;
reduced_absolute_inversion_input_params.x1_max = x1_max;
reduced_absolute_inversion_input_params.Gm1 = Gm1_absolute;
reduced_absolute_inversion_input_params.Gm2 = Gm2_absolute;
reduced_absolute_inversion_input_params.Cm1 = Cm1_absolute;
reduced_absolute_inversion_input_params.Cm2 = Cm2_absolute;

% Define the subnetwork design params.
R1_relative = 20e-3;                                         % [V] Maximum Encoded Input.
R2_relative = 20e-3;                                         % [V] Maximum Decoded Input.
...
% Store the subnetwork design params in a structure.
reduced_relative_inversion_input_params.c1 = c1;
reduced_relative_inversion_input_params.delta = delta;
reduced_relative_inversion_input_params.x1_max = x1_max;
reduced_relative_inversion_input_params.R1 = R1_relative;
reduced_relative_inversion_input_params.R2 = R2_relative;
reduced_relative_inversion_input_params.Gm1 = Gm1_relative;
reduced_relative_inversion_input_params.Gm2 = Gm2_relative;
reduced_relative_inversion_input_params.Cm1 = Cm1_relative;
reduced_relative_inversion_input_params.Cm2 = Cm2_relative;
...
f_encode2_relative = @( x2 ) network_utilities.encode_reduced_relative_inversion_output( x2, c1, delta, x1_max, R2_relative );
...
f_decode2_relative = @( U2 ) network_utilities.decode_reduced_relative_inversion_output( U2, c1, delta, x1_max, R2_relative );
...
[ reduced_absolute_inversion_output_params, neurons_absolute, synapses_absolute, applied_currents_absolute, neuron_manager_absolute, synapse_manager_absolute, applied_current_manager_absolute, network_absolute ] = network_absolute.create_reduced_inversion_subnetwork( reduced_absolute_inversion_input_params, 'absolute', network_absolute.neuron_manager, network_absolute.synapse_manager, network_absolute.applied_current_manager, true, true, false, undetected_option );
[ reduced_relative_inversion_output_params, neurons_relative, synapses_relative, applied_currents_relative, neuron_manager_relative, synapse_manager_relative, applied_current_manager_relative, network_relative ] = network_relative.create_reduced_inversion_subnetwork( reduced_relative_inversion_input_params, 'relative', network_relative.neuron_manager, network_relative.synapse_manager, network_relative.applied_current_manager, true, true, false, undetected_option );

% Unpack the subnetwork output params.
[ c2_absolute, x2max_absolute, R1_absolute, R2_absolute, Gna1_absolute, Gna2_absolute, dEs21_absolute, gs21_absolute, Ia2_absolute ] = network_absolute.unpack_reduced_absolute_inversion_output_params( reduced_absolute_inversion_output_params, network_absolute.neuron_manager, network_absolute.synapse_manager, network_absolute.applied_current_manager, undetected_option );
[ c2_relative, x2max_relative, Gna1_relative, Gna2_relative, dEs21_relative, gs21_relative, Ia2_relative ] = network_relative.unpack_reduced_relative_inversion_output_params( reduced_relative_inversion_output_params, network_relative.neuron_manager, network_relative.synapse_manager, network_relative.applied_current_manager, undetected_option );
...
fprintf( '----------------------------------- REDUCED ABSOLUTE INVERSION SUBNETWORK -----------------------------------\n\n' )
...
fprintf( '----------------------------------- REDUCED RELATIVE INVERSION SUBNETWORK -----------------------------------\n\n' )
...
if simulate_flag                            % If we want to simulate the network...
    ...
    save( [ save_directory, '\', 'reduced_absolute_inversion_subnetwork_error' ], 'Ias_magnitude_absolute', 'Us_numerical_absolute', 'xs_numerical_absolute' )
    save( [ save_directory, '\', 'reduced_relative_inversion_subnetwork_error' ], 'Ias_magnitude_relative', 'Us_numerical_relative', 'xs_numerical_relative' )

else                % Otherwise... ( We must want to load data from an existing simulation... )

    % Load the simulation results.
    data_absolute = load( [ load_directory, '\', 'reduced_absolute_inversion_subnetwork_error' ] );
    data_relative = load( [ load_directory, '\', 'reduced_relative_inversion_subnetwork_error' ] );
...
Us_theoretical_absolute( :, 2 ) = network_absolute.compute_encoded_achieved_reduced_inversion_sso( Us_theoretical_absolute( :, 1 ), R1_absolute, Gm2_absolute, gs21_absolute, dEs21_absolute, Ia2_absolute, network_absolute.neuron_manager, network_absolute.synapse_manager, network_absolute.applied_current_manager, undetected_option, network_absolute.network_utilities );
Us_theoretical_relative( :, 2 ) = network_relative.compute_encoded_achieved_reduced_inversion_sso( Us_theoretical_relative( :, 1 ), R1_relative, Gm2_relative, gs21_relative, dEs21_relative, Ia2_relative, network_relative.neuron_manager, network_relative.synapse_manager, network_relative.applied_current_manager, undetected_option, network_relative.network_utilities );
...
header_str_encoded_absolute = 'Reduced Absolute Inversion Encoded Error Statistics';
header_str_decoded_absolute = 'Reduced Absolute Inversion Decoded Error Statistics';

% Define the relative header strings.
header_str_encoded_relative = 'Reduced Relative Inversion Encoded Error Statistics';
header_str_decoded_relative = 'Reduced Relative Inversion Decoded Error Statistics';
...
fig_absolute_encoded_ssr = plotting_utilities.plot_steady_state_response( Us_desired_absolute( :, 1 ), Us_desired_absolute( :, 2 ), Us_theoretical_absolute( :, 2 ), Us_numerical_absolute( :, 2 ), scale, subnetwork_name, 'Absolute', 'Encoded', 'U1', 'U2', 'mV', save_flag, save_directory );
fig_absolute_decoded_ssr = plotting_utilities.plot_steady_state_response( xs_desired_absolute( :, 1 ), xs_desired_absolute( :, 2 ), xs_theoretical_absolute( :, 2 ), xs_numerical_absolute( :, 2 ), scale, subnetwork_name, 'Absolute', 'Decoded', 'x1', 'x2', '-', save_flag, save_directory );
fig_relative_encoded_ssr = plotting_utilities.plot_steady_state_response( Us_desired_relative( :, 1 ), Us_desired_relative( :, 2 ), Us_theoretical_relative( :, 2 ), Us_numerical_relative( :, 2 ), scale, subnetwork_name, 'Relative', 'Encoded', 'U1', 'U2', 'mV', save_flag, save_directory );
fig_relative_decoded_ssr = plotting_utilities.plot_steady_state_response( xs_desired_relative( :, 1 ), xs_desired_relative( :, 2 ), xs_theoretical_relative( :, 2 ), xs_numerical_relative( :, 2 ), scale, subnetwork_name, 'Relative', 'Decoded', 'x1', 'x2', '-', save_flag, save_directory );

% Create a plot that compares the absolute and relative steady state responses using both encoded and decoded.
fig_encoded_ssr = plotting_utilities.plot_steady_state_response_comparison( Us_desired_absolute( :, 1 ), Us_desired_absolute( :, 2 ), Us_theoretical_absolute( :, 2 ), Us_numerical_absolute( :, 2 ), color_absolute, Us_desired_relative( :, 1 ), Us_desired_relative( :, 2 ), Us_theoretical_relative( :, 2 ), Us_numerical_relative( :, 2 ), color_relative, scale, subnetwork_name, 'Encoded', 'U1', 'U2', 'mV', save_flag, save_directory );
fig_decoded_ssr = plotting_utilities.plot_steady_state_response_comparison( xs_desired_absolute( :, 1 ), xs_desired_absolute( :, 2 ), xs_theoretical_absolute( :, 2 ), xs_numerical_absolute( :, 2 ), color_absolute, xs_desired_relative( :, 1 ), xs_desired_relative( :, 2 ), xs_theoretical_relative( :, 2 ), xs_numerical_relative( :, 2 ), color_relative, scale, subnetwork_name, 'Decoded', 'x1', 'x2', '-', save_flag, save_directory );


%% Plot the Subnetwork Steady State Error.

% Plot the encoded and decoded steady state error.
fig_encoded_sse = plotting_utilities.plot_steady_state_error_comparison( Us_theoretical_absolute( :, 1 ), errors_theoretical_encoded_absolute, errors_numerical_encoded_absolute, color_absolute, Us_theoretical_relative( :, 1 ), errors_theoretical_encoded_relative, errors_numerical_encoded_relative, color_relative, scale, subnetwork_name, 'Encoded', { 'U1', 'E' }, { 'mV', 'mV' }, save_flag, save_directory );
fig_decoded_sse = plotting_utilities.plot_steady_state_error_comparison( xs_theoretical_absolute( :, 1 ), errors_theoretical_decoded_absolute, errors_numerical_decoded_absolute, color_absolute, xs_theoretical_relative( :, 1 ), errors_theoretical_decoded_relative, errors_numerical_decoded_relative, color_relative, scale, subnetwork_name, 'Decoded', { 'x1', 'E' }, { '-', '-' }, save_flag, save_directory );

% Plot the encoded and decoded steady state error percentage.
fig_encoded_sse_percentage = plotting_utilities.plot_steady_state_error_percentage_comparison( Us_theoretical_absolute( :, 1 ), error_percentages_theoretical_encoded_absolute, error_percentages_numerical_encoded_absolute, color_absolute, Us_theoretical_relative( :, 1 ), error_percentages_theoretical_encoded_relative, error_percentages_numerical_encoded_relative, color_relative, scale, subnetwork_name, 'Encoded', { 'U1', 'E' }, { 'mV', '%' }, save_flag, save_directory );
fig_decoded_sse_percentage = plotting_utilities.plot_steady_state_error_percentage_comparison( xs_theoretical_absolute( :, 1 ), error_percentages_theoretical_decoded_absolute, error_percentages_numerical_decoded_absolute, color_absolute, xs_theoretical_absolute( :, 1 ), error_percentages_theoretical_decoded_relative, error_percentages_numerical_decoded_relative, color_relative, scale, subnetwork_name, 'Decoded', { 'x1', 'E' }, { '-', '%' }, save_flag, save_directory );
...
fig_encoded_sse_difference = plotting_utilities.plot_steady_state_error_difference( Us_theoretical_absolute( :, 1 ), error_diff_theoretical_encoded, error_diff_numerical_encoded, scale, subnetwork_name, 'Encoded', { 'U1', 'dE' }, { 'mV', 'mV' }, save_flag, save_directory );
fig_decoded_sse_difference = plotting_utilities.plot_steady_state_error_difference( xs_theoretical_absolute( :, 1 ), error_diff_theoretical_decoded, error_diff_numerical_decoded, scale, subnetwork_name, 'Decoded', { 'x1', 'dE' }, { '-', '-' }, save_flag, save_directory );
...
fig_encoded_sse_percentage_difference = plotting_utilities.plot_steady_state_error_percentage_difference( Us_theoretical_absolute( :, 1 ), error_percent_diff_theoretical_encoded, error_percent_diff_numerical_encoded, scale, subnetwork_name, 'Encoded', { 'U1', 'dE' }, { 'mV', '%' }, save_flag, save_directory );
fig_decoded_sse_percentage_difference = plotting_utilities.plot_steady_state_error_percentage_difference( xs_theoretical_absolute( :, 1 ), error_percent_diff_theoretical_decoded, error_percent_diff_numerical_decoded, scale, subnetwork_name, 'Decoded', { 'x1', 'dE' }, { '-', '%' }, save_flag, save_directory );
...
fig_encoded_sse_improvement = plotting_utilities.plot_steady_state_error_improvement( Us_theoretical_absolute( :, 1 ), error_improv_theoretical_encoded, error_improv_numerical_encoded, scale, subnetwork_name, 'Encoded', { 'U1', 'dE' }, { 'mV', 'mV' }, save_flag, save_directory );
fig_decoded_sse_improvement = plotting_utilities.plot_steady_state_error_improvement( xs_theoretical_absolute( :, 1 ), error_improv_theoretical_decoded, error_improv_numerical_decoded, scale, subnetwork_name, 'Decoded', { 'x1', 'dE' }, { '-', '-' }, save_flag, save_directory );
...
fig_encoded_sse_percentage_improvement = plotting_utilities.plot_steady_state_error_percentage_improvement( Us_theoretical_absolute( :, 1 ), error_percent_improv_theoretical_encoded, error_percent_improv_numerical_encoded, scale, subnetwork_name, 'Encoded', { 'U1', 'dE' }, { 'mV', '%' }, save_flag, save_directory );
fig_decoded_sse_percentage_improvement = plotting_utilities.plot_steady_state_error_percentage_improvement( xs_theoretical_absolute( :, 1 ), error_percent_improv_theoretical_decoded, error_percent_improv_numerical_decoded, scale, subnetwork_name, 'Decoded', { 'x1', 'dE' }, { '-', '%' }, save_flag, save_directory );


%% Plot the Numerical Stability Information.

% Plot the RK4 maximum timestep vs the encoded and decoded input.
fig_rk4_maximum_step_size_encoded = plotting_utilities.plot_max_rk4_step_size( Us_desired_absolute( :, 1 ), dts_absolute, color_absolute, Us_desired_relative( :, 1 ), dts_relative, color_relative, scale, subnetwork_name, 'Encoded', { 'U1', 'dT' }, { 'mV', 'ms' }, save_flag, save_directory );
fig_rk4_maximum_step_size_decoded = plotting_utilities.plot_max_rk4_step_size( xs_desired_absolute( :, 1 ), dts_absolute, color_absolute, xs_desired_relative( :, 1 ), dts_relative, color_relative, scale, subnetwork_name, 'Decoded', { 'x1', 'dT' }, { '-', 'ms' }, save_flag, save_directory );
