...
[ c2, x2_max, Gna1, Gna2, dEs21, gs21, Ia2 ] = network.unpack_relative_inversion_output_parameters( inversion_output_parameters, network.neuron_manager, network.synapse_manager, network.applied_current_manager, undetected_option );
...
% Compute the desired and achieved steady state output.
U2s_desired = network.compute_encoded_desired_relative_inversion_sso( U1s, c1, c3, delta, R1, R2, network.network_utilities );
...
% Store the desired and theoretically achieved steady state results in arrays.
...
fig = figure( 'Color', 'w', 'Name', 'RI: Encoded Desired & Achieved (Theory) SS Behavior' ); hold on, grid on, xlabel( 'Encoded Input, U1 [mV]' ), ylabel( 'Encoded Output, U2 [mV]' ), title( 'RI: Encoded Desired & Achieved (Theory) SS Behavior' )
...
saveas( fig, [ save_directory, '\', 'relative_inversion_desired_achieved_theory_encoded' ] )

% Plot the decoded desired and achieved absolute transmission formulation results.
fig = figure( 'Color', 'w', 'Name', 'RI: Decoded Desired & Achieved (Theory) SS Behavior' ); hold on, grid on, xlabel( 'Decoded Input, x [-]' ), ylabel( 'Decoded Output, y [-]' ), title( 'RI: Decoded Desired & Achieved (Theory) SS Behavior' )
...
legend( 'Desired', 'Achieved (Theory)' )
saveas( fig, [ save_directory, '\', 'relative_inversion_desired_achieved_theory_decoded' ] )

% Plot the RK4 maximum timestep vs the encoded input.
fig = figure( 'Color', 'w', 'Name', 'RI: RK4 Maximum Timestep vs Encoded Input' ); hold on, grid on, xlabel( 'Encoded Input, U1 [mV]' ), ylabel( 'RK4 Maximum Timestep, dt [s]' ), title( 'RI: RK4 Maximum Timestep vs Encoded Input' )
plot( scale*Us_desired( :, 1 ), dts, '-', 'Linewidth', 3 )
saveas( fig, [ save_directory, '\', 'relative_inversion_rk4_maximum_timestep_encoded' ] )

% Plot the RK4 maximum timestep vs the decoded input.
fig = figure( 'Color', 'w', 'Name', 'RI: RK4 Maximum Timestep vs Decoded Input' ); hold on, grid on, xlabel( 'Decoded Input, x [-]' ), ylabel( 'RK4 Maximum Timestep, dt [s]' ), title( 'RI: RK4 Maximum Timestep vs Decoded Input' )
plot( scale*Xs_desired( :, 1 ), dts, '-', 'Linewidth', 3 )
saveas( fig, [ save_directory, '\', 'relative_inversion_rk4_maximum_timestep_decoded' ] )

% Plot the linearized system condition numbers vs the encoded input.
fig = figure( 'Color', 'w', 'Name', 'RI: Condition Numbers vs Encoded Input' ); hold on, grid on, xlabel( 'Encoded Input, U1 [mV]' ), ylabel( 'Condition Number [-]' ), title( 'RI: Condition Number vs Encoded Input' )
plot( scale*Us_desired( :, 1 ), condition_numbers, '-', 'Linewidth', 3 )
saveas( fig, [ save_directory, '\', 'relative_inversion_condition_numbers_encoded' ] )

% Plot the linearized system condition numbers vs the decoded input.
fig = figure( 'Color', 'w', 'Name', 'RI: Condition Numbers vs Decoded Input' ); hold on, grid on, xlabel( 'Decoded Input, x [-]' ), ylabel( 'Condition Number [-]' ), title( 'RI: Condition Number vs Decoded Input' )
plot( scale*Xs_desired( :, 1 ), condition_numbers, '-', 'Linewidth', 3 )
saveas( fig, [ save_directory, '\', 'relative_inversion_condition_numbers_decoded' ] )
...
if simulate_flag                            % If we want to simulate the network...
    ...
    save( [ save_directory, '\', 'relative_inversion_subnetwork_error' ], 'xs1_input', 'Us1_input', 'Ias1_input', 'Us_achieved_numerical', 'Xs_achieved_numerical' )
...
Us2_desired = network.compute_encoded_desired_relative_inversion_sso( Us_achieved_numerical( :, 1 ), c1, c3, delta, R1, R2, network.network_utilities );
...
header_str_encoded = 'Relative Inversion Encoded Summary Statistics\n';
header_str_decoded = 'Relative Inversion Decoded Summary Statistics\n';
...
fig = figure( 'Color', 'w', 'Name', 'RI: Encoded Steady State Response (Desired)' ); hold on, grid on, xlabel( 'Encoded Input, U1 [mV]' ), ylabel( 'Encoded Output, U2 [mV]' ), title( 'RI: Encoded Steady State Response (Desired)' )
plot( scale*Us_desired( :, 1 ), scale*Us_desired( :, 2 ), '-', 'Linewidth', 3 )
saveas( fig, [ save_directory, '\', 'relative_inversion_ss_response_desired_encoded' ] )

% Create a plot of the decoded desired network behavior.
fig = figure( 'Color', 'w', 'Name', 'RI: Decoded Steady State Response (Desired)' ); hold on, grid on, xlabel( 'Decoded Input, x1 [-]' ), ylabel( 'Decoded Output, x2 [-]' ), title( 'RI: Decoded Steady State Response (Desired)' )
plot( scale*Xs_desired( :, 1 ), scale*Xs_desired( :, 2 ), '-', 'Linewidth', 3 )
saveas( fig, [ save_directory, '\', 'relative_inversion_ss_response_desired_decoded' ] )

% Create a plot of the encoded achieved numerical network behavior.
fig = figure( 'Color', 'w', 'Name', 'RI: Encoded Steady State Response (Achieved Theoretical)' ); hold on, grid on, xlabel( 'Encoded Input, U1 [mV]' ), ylabel( 'Encoded Output, U2 [mV]' ), title( 'RI: Encoded Steady State Response (Achieved Theoretical)' )
plot( scale*Us_achieved_theoretical( :, 1 ), scale*Us_achieved_theoretical( :, 2 ), '-', 'Linewidth', 3 )
saveas( fig, [ save_directory, '\', 'relative_inversion_ss_response_achieved_theoretical_encoded' ] )

% Create a plot of the decoded achieved numerical network behavior.
fig = figure( 'Color', 'w', 'Name', 'RI: Decoded Steady State Response (Achieved Theoretical)' ); hold on, grid on, xlabel( 'Decoded Input, x1 [-]' ), ylabel( 'Decoded Output, x2 [-]' ), title( 'RI: Decoded Steady State Response (Achieved Theoretical)' )
plot( scale*Xs_achieved_theoretical( :, 1 ), scale*Xs_achieved_theoretical( :, 2 ), '-', 'Linewidth', 3 )
saveas( fig, [ save_directory, '\', 'relative_inversion_ss_response_achieved_theoretical_decoded' ] )

% Create a plot of the encoded achieved numerical network behavior.
fig = figure( 'Color', 'w', 'Name', 'RI: Encoded Steady State Response (Achieved Numerical)' ); hold on, grid on, xlabel( 'Encoded Input, U1 [mV]' ), ylabel( 'Encoded Input, U2 [mV]' ), title( 'RI: Encoded Steady State Response (Achieved Numerical)' )
plot( scale*Us_achieved_numerical( :, 1 ), scale*Us_achieved_numerical( :, 2 ), '-', 'Linewidth', 3 )
saveas( fig, [ save_directory, '\', 'relative_inversion_ss_response_achieved_numerical_encoded' ] )

% Create a plot of the decoded achieved numerical network behavior.
fig = figure( 'Color', 'w', 'Name', 'RI: Decoded Steady State Response (Achieved Numerical)' ); hold on, grid on, xlabel( 'Decoded Input, x1 [-]' ), ylabel( 'Decoded Output, x2 [-]' ), title( 'RI: Decoded Steady State Response (Achieved Numerical)' )
plot( scale*Xs_achieved_numerical( :, 1 ), scale*Xs_achieved_numerical( :, 2 ), '-', 'Linewidth', 3 )
saveas( fig, [ save_directory, '\', 'relative_inversion_ss_response_achieved_numerical_decoded' ] )

% Create a plot of the encoded desired, achieved (theory), and achieved (numerical) network behavior.
fig = figure( 'Color', 'w', 'Name', 'RI: Encoded Steady State Response (Comparison)' ); hold on, grid on, xlabel( 'Encoded Input, U1 [mV]' ), ylabel( 'Encoded Output, U2 [mV]' ), title( 'RI: Encoded Steady State Response (Comparison)' )
...
saveas( fig, [ save_directory, '\', 'relative_inversion_ss_response_comparison_encoded' ] )

% Create a plot of the decoded desired, achieved (theory), and achieved (numerical) network behavior.
fig = figure( 'Color', 'w', 'Name', 'RI: Decoded Steady State Response (Comparison)' ); hold on, grid on, xlabel( 'Decoded Input, x1 [-]' ), ylabel( 'Decoded Output, x2 [-]' ), title( 'RI: Decoded Steady State Response (Comparison)' )
...
legend( [ h1, h2, h3 ], { 'Desired', 'Achieved (Theoretical)', 'Achieved (Numerical)' }, 'Location', 'Best' )
saveas( fig, [ save_directory, '\', 'relative_inversion_ss_response_comparison_decoded' ] )

% Create a plot of the encoded theoretical and numerical error.
fig = figure( 'Color', 'w', 'Name', 'RI: Encoded Steady State Error' ); hold on, grid on, xlabel( 'Encoded Input, U1 [mV]' ), ylabel( 'Encoded Error, E [mV]' ), title( 'RI: Encoded Steady State Error' )
...
saveas( fig, [ save_directory, '\', 'relative_inversion_ss_response_error_encoded' ] )

% Create a plot of the decoded theoretical and numerical error.
fig = figure( 'Color', 'w', 'Name', 'RI: Decoded Steady State Error' ); hold on, grid on, xlabel( 'Decoded Input, x1 [-]' ), ylabel( 'Decoded Error, E [-]' ), title( 'RI: Decoded Steady State Error' )
...
legend( { 'Theoretical', 'Numerical' }, 'Location', 'Best', 'Orientation', 'Horizontal' )
saveas( fig, [ save_directory, '\', 'relative_inversion_ss_response_error_decoded' ] )

% Create a plot of the encoded theoretical and numerical percentage error.
fig = figure( 'Color', 'w', 'Name', 'RI: Encoded Steady State Error Percentage' ); hold on, grid on, xlabel( 'Encoded Input, U1 [mV]' ), ylabel( 'Encoded Error Percentage, E [%]' ), title( 'RI: Encoded Steady State Error Percentage' )
...
legend( { 'Theoretical', 'Numerical' }, 'Location', 'Best', 'Orientation', 'Horizontal' )
saveas( fig, [ save_directory, '\', 'relative_inversion_ss_response_error_percentage_encoded' ] )

% Create a plot of the decoded theoretical and numerical percentage error.
fig = figure( 'Color', 'w', 'Name', 'RI: Decoded Steady State Error Percentage' ); hold on, grid on, xlabel( 'Decoded Input, x1 [-]' ), ylabel( 'Decoded Error Percentage, E [%]' ), title( 'RI: Decoded Steady State Error Percentage' )
...
legend( { 'Theoretical', 'Numerical' }, 'Location', 'Best', 'Orientation', 'Horizontal' )
saveas( fig, [ save_directory, '\', 'relative_inversion_ss_response_error_percentage_decoded' ] )
