...
addpath('C:\GitHub\Quadruped_Robot\Code\Matlab\Analysis\DampedLeg_Krnacik\Haonan\Parameter optimization\Results\AllTrialResultsD1_knee')
addpath('C:\GitHub\Quadruped_Robot\Code\Matlab\Analysis\DampedLeg_Krnacik\Haonan\Parameter optimization\Results\AllTrialResultsD1_hip')
addpath('C:\GitHub\Quadruped_Robot\Code\Matlab\Analysis\DampedLeg_Krnacik\Haonan\Parameter optimization\Results\AllTrialResultsD1_ankle')

% Create folder to save results to and add file path
folder_title = 'PSOD1_BigRat_results';
...
upscal = [1.5 1.5 2 2 3 3];
lowscal = [10 10 2 2 5 5];
