...
%is this a fair assumption now that we have accurate solidworks data?
...
Fmuscles_total_desired = JointTorques2TotalMuscleForcesNew( taus_desired, Pmuscles_desired, Pjoints_desired, muscle_joint_orientations, Fmuscles_total_lowbnd );
