...
Ihome_cm3 = [0.000033, 0.000005, 0.00001; 0.000005, 0.001383, 0; 0.00001, 0, 0.001372];                         % [m^2/kg] Link Moment of Inertia at COM in the Local Frame.
...
Phome_joint3 = [0.26118; 0; 0.05008];                                                                    % [m] Joint Location in the Global Frame.                                                                          % [m] Joint Location in the Global Frame.
Phome_joint4 = [0.49824; 0; 0.05008];                                                                    % [m] Joint Location in the Global Frame.
...
%     fprintf('GENERATING DESIRED END EFFECTOR TRAJECTORY FOR Y ROTATION... Done.\n\n')
    ...
    thetas_desired = (pi/180)*[ -90*ones( 1, num_timesteps ); linspace( -15, 15, num_timesteps ); 30*ones( 1, num_timesteps ); -10.21*ones( 1, num_timesteps ) ];
...
% plot( ts, taus_desired(1, :), '-', 'Linewidth', 3 )
% plot( ts, taus_desired(2, :), '-', 'Linewidth', 3 )
% plot( ts, taus_desired(3, :), '-', 'Linewidth', 3 )
% plot( ts, taus_desired(4, :), '-', 'Linewidth', 3 )
