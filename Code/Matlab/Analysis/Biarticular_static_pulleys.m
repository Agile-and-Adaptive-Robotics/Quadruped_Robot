...
r1_AEb_pos2 = rotz(90) * (r1_AEb_pos2 - ankle_pos2)+ ankle_pos2;
...
plot([r2_AEb_pos2(1) lower_AEb_pos2(1)], [r2_AEb_pos2(2) lower_AEb_pos2(2)])
...
% vectors
delta_L_KFb = (norm(r1_KFb_pos1 - b_KFb_top) + (pi()/2)*(((r1_KFb_length^2) + (r2_KFb_length^2))/2)^0.5)- norm(r2_KFb_pos2' - b_KFb_top);
delta_L_KEb = (norm(r2_KEb_pos2' - b_KEb_top) + (pi()/2)*(((r1_KEb_length^2) + (r2_KEb_length^2))/2)^0.5)- norm(r1_KEb_pos1 - b_KEb_top);
delta_L_AEb = (norm(r1_AEb_pos1 - upper_AEb_pos1) + (pi()/2)*(((r1_AEb_length^2) + (r2_AEb_length^2))/2)^0.5)- norm(r2_AEb_pos2 - upper_AEb_pos2);
