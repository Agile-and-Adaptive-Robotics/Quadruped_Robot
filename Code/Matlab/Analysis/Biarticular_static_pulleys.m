...
% Define length of actuatorsL_KFb = 14 * (0.0254);              
...
L_AEb = 7 * (0.0254);              % [m] Biarticular ankle extensor length (inches to meters conversion)
...
upper_AEb_pos1 = r1_AEb_pos1 + L_AEb * ((r1_KFb_pos1 - r1_AEb_pos1) / norm(r1_AEb_pos1 - r1_KFb_pos1));
...
% Plot the ankle extensor actuator
plot([upper_AEb_pos2(1) r2_AEb_pos2(1)], [upper_AEb_pos2(2) r2_AEb_pos2(2)], '-b', 'LineWidth', 3)
