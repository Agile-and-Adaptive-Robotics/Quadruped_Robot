%% Three Neuron CPG Linear Chain.

% This script simulates a CPG network with three neurons in a chain 1 o-o 2 o-o 3, where 1 o-o 2 and 2 o-o 3 are two neuron CPGs that have been linked.
...
gsyn32_max = TwoNeuronCPGSubnetworkSynConductance(delta, Gm3, dEsyn32, Am3, Sm3, dEm3, Ah3, Sh3, dEh3, dEna3, Gna3);
gsyn21_max = (-Gm2.*delta + Gna2.*fminf(delta).*fhinf(delta).*(dEna2 - delta))./(2*delta - dEsyn21 - dEsyn23);
gsyn23_max = gsyn21_max;
