...
FAP_HE = sumT_H / LAP_HE(2);                                           %[N]
%FAP_HF = 0.5 * sqrt((sumT_H / LAP_HF(1))^2 + (sumT_H / LAP_HF(2))^2); %[N]
FAP_HF = sumT_H / LAP_HF(2);                                           %[N]

%FAP_KE = sqrt((sumT_K / LAP_KE(1))^2 + (sumT_K / LAP_KE(2))^2);       %[N]
FAP_KE = sumT_K / LAP_KE(1);                                           %[N]
%FAP_KF = sqrt((sumT_K / LAP_KF(1))^2 + (sumT_K / LAP_KF(2))^2);       %[N]
FAP_KF = sumT_K / LAP_KF(1);                                           %[N]
