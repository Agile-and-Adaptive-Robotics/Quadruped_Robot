...
% rotation
AEbl_pulleyx = 0.25 * (0.0254);                % [m] (inches to meter conversion)
AEbl_pulleyy = -0.25 * (0.0254);               % [m] (inches to meter conversion)

% Define the lower attachment point of the biarticular ankle actuator
% string to the foot in terms of displacement from the ankle axis of
% rotation
AEbl_x = 0.25 * (0.0254);                % [m] (inches to meter conversion)
AEbl_y = -0.5 * (0.0254);                % [m] (inches to meter conversion)
...
AEbu_y = 1.25 * (0.0254);              % [m] (inches to meter conversion)
