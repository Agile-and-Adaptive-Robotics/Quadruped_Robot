...
% Define the length of the upper actuator attachment to the point of
% rotation
b_length = 1 * (0.0254);             % [m] (inches to meter conversion)
...
% Define the actuator upper attachment point to body
KFb_upper_pos1 = b_KFb_top + b_length * (KFb_pin_pos1 - b_KFb_top) / norm(KFb_pin_pos1 - b_KFb_top);   % [m]

% Define the end of actuator from known unit vector, length, and starting
% point of the upper actuator end
KFb_lower_pos1 = KFb_upper_pos1 + L_KFb * (KFb_pin_pos1 - b_KFb_top) / norm(KFb_pin_pos1 - b_KFb_top); % [m]

%Define length of s, will need for second KFb_lower_pos calculation
s = norm(KFb_pin_pos1 - KFb_lower_pos1); % [m]
...
plot(KFb_lower_pos1(1), KFb_lower_pos1(2), '*r')
...
plot([KFb_upper_pos1(1) KFb_lower_pos1(1)], [KFb_upper_pos1(2) KFb_lower_pos1(2)], '-b', 'Linewidth', 6)
plot([KFb_lower_pos1(1) KFb_pin_pos1(1)], [KFb_lower_pos1(2) KFb_pin_pos1(2)])
...
plot(KFb_upper_pos1(1), KFb_upper_pos1(2), 'xr', 'LineWidth', 5)
