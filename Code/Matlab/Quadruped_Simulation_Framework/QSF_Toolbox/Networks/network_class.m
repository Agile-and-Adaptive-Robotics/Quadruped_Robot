...
%         end
        ...
        function [ dEs21, gs21, synapse_ID, synapses, synapse_manager, self ] = design_transmission_synapse( self, neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager, set_flag, undetected_option )
            ...
            [ dEs21, gs21, synapse_ID, synapses, synapse_manager ] = synapse_manager.design_transmission_synapse( neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager.synapses, true, undetected_option );
        ...
        function [ dEs, gs, synapse_IDs, synapses, synapse_manager, self ] = design_addition_synapses( self, neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager, set_flag, undetected_option )
            ...
            [ dEs, gs, synapse_IDs, synapses, synapse_manager ] = synapse_manager.design_addition_synapses( neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager.synapses, true, undetected_option );
        ...
        function [ dEs, gs, synapse_IDs, synapses, synapse_manager, self ] = design_subtraction_synapses( self, neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager, set_flag, undetected_option )
            ...
            [ dEs, gs, synapse_IDs, synapses, synapse_manager ] = synapse_manager.design_subtraction_synapses( neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager.synapses, true, undetected_option );
        ...
        function [ dEs21, gs21, synapse_ID, synapses, synapse_manager, self ] = design_inversion_synapse( self, neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager, set_flag, undetected_option )
            ...
            [ dEs21, gs21, synapse_ID, synapses, synapse_manager ] = synapse_manager.design_inversion_synapse( neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager.synapses, true, undetected_option );
        ...
        function [ dEs21, gs21, synapse_ID, synapses, synapse_manager, self ] = design_reduced_inversion_synapse( self, neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager, set_flag, undetected_option )
            ...
            % Design the inversion subnetwork synapse.            
            [ dEs21, gs21, synapse_ID, synapses, synapse_manager ] = synapse_manager.design_reduced_inversion_synapse( neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager.synapses, true, undetected_option );
        ...
        function [ dEs, gs, synapse_IDs, synapses, synapse_manager, self ] = design_division_synapses( self, neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager, set_flag, undetected_option )
            ...
            [ dEs, gs, synapse_IDs, synapses, synapse_manager ] = synapse_manager.design_division_synapses( neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager.synapses, true, undetected_option );
        ...
        function [ dEs, gs, synapse_IDs, synapses, synapse_manager, self ] = design_reduced_division_synapses( self, neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager, set_flag, undetected_option )
            ...
            % Design the division subnetwork synapses.            
            [ dEs, gs, synapse_IDs, synapses, synapse_manager ] = synapse_manager.design_reduced_division_synapses( neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager.synapses, true, undetected_option );
        ...
        % Implement a function to design the synapses of a division subnetwork.
        function [ dEs, gs, synapse_IDs, synapses, synapse_manager, self ] = design_dai_synapses( self, neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager, set_flag, undetected_option )
            ...
            % Design the division subnetwork synapses.                        
            [ dEs, gs, synapse_IDs, synapses, synapse_manager ] = synapse_manager.design_dai_synapses( neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager.synapses, true, undetected_option );
        ...
        function [ dEs, gs, synapse_IDs, synapses, synapse_manager, self ] = design_reduced_dai_synapses( self, neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager, set_flag, undetected_option )
            ...
            % Design the division subnetwork synapses.                        
            [ dEs, gs, synapse_IDs, synapses, synapse_manager ] = synapse_manager.design_reduced_dai_synapses( neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager.synapses, true, undetected_option );
        ...
        function [ dEs, gs, synapse_IDs, synapses, synapse_manager, self ] = design_multiplication_synapses( self, neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager, set_flag, undetected_option )
            ...
            [ dEs, gs, synapse_IDs, synapses, synapse_manager ] = synapse_manager.design_multiplication_synapses( neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager.synapses, true, undetected_option );
        ...
        function [ dEs, gs, synapse_IDs, synapses, synapse_manager, self ] = design_reduced_multiplication_synapses( self, neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager, set_flag, undetected_option )
            ...
            % Design the multiplication subnetwork synapses.                        
            [ dEs, gs, synapse_IDs, synapses, synapse_manager ] = synapse_manager.design_reduced_multiplication_synapses( neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager.synapses, true, undetected_option );
...
%         end
        ...
        function transmission_parameters = pack_relative_transmission_parameters( self, R2, Gm2, Ia2, neuron_manager, applied_current_manager, undetected_option )
            ...
            if nargin < 4, Ia2 = applied_current_manager.get_applied_current_property( applied_current_manager.to_neuron_ID2applied_current_ID( neuron_manager.neuron.neuron_IDs( 2 ), applied_current_manager.applied_currents, undetected_option ), 'Ias', true, applied_current_manager.applied_currents, undetected_option ); end
            if nargin < 3, Gm2 = neuron_manager.get_neuron_property( neuron_manager.neuron.neuron_IDs( 2 ), 'R', true, neuron_manager.neurons, undetected_option ); end
        ...
        function addition_parameters = pack_relative_addition_parameters( self, cs, R_n, Gm_n, Ia_n, neuron_manager, applied_current_manager, undetected_option )
            ...
            if nargin < 5, Ia_n = applied_current_manager.get_applied_current_property( applied_current_manager.to_neuron_ID2applied_current_ID( neuron_manager.neuron.neuron_IDs( end ), applied_current_manager.applied_currents, undetected_option ), 'Ias', true, applied_current_manager.applied_currents, undetected_option ); end
            if nargin < 4, Gm_n = neuron_manager.get_neuron_property( neuron_manager.neuron.neuron_IDs( end ), 'Gm', true, neuron_manager.neurons, undetected_option ); end
            if nargin < 3, R_n = neuron_manager.get_neuron_property( neuron_manager.neurons.neuron_IDs( end ), 'R', true, neuron_manager.neurons, undetected_option ); end
            if nargin < 2, cs = self.c_relative_addition_DEFAULT*ones( 1, neuron_manager.num_neurons - 1 ); end
        ...
        function subtraction_parameters = pack_relative_subtraction_parameters( self, cs, ss, Rs_input, Gm_n, Ia_n, neuron_manager, applied_current_manager, undetected_option )
            
            % Get parameters from synapse manager: c_k, s_k, R_k, Gm_n, Ia_n
            ...
            if nargin < 4, Rs_input = neuron_manager.get_neuron_property( neuron_manager.neurons.neuron_IDs( 1:( end - 1 ) ), 'R', true, neuron_manager.neurons, undetected_option ); end
            if nargin < 3, ss = self.signature_DEFAULT; end
            if nargin < 2, cs = self.c_relative_subtraction_DEFAULT*ones( 1, neuron_manager.num_neurons - 1 ); end
        ...
        % Implement a function to pack the parameters for a relative subtraction subnetwork.
        function inversion_parameters = pack_relative_inversion_parameters( self, delta, R2, Gm2, Ia2, neuron_manager, applied_current_manager, undetected_option )
           
            % Get parameters from synapse manager: delta, Gm2, Ia2
            % Get parameters from applied current manager: Gm2, R2
            
            % Set the default input arguments.
            if nargin < 8, undetected_option = self.undetected_option_DEFAULT; end
            if nargin < 7, applied_current_manager = self.applied_current_manager; end
            if nargin < 6, neuron_manager = self.neuron_manager; end
            if nargin < 5, Ia2 = applied_current_manager.get_applied_current_property( applied_current_manager.to_neuron_ID2applied_current_ID( neuron_manager.neuron.neuron_IDs( 2 ), applied_current_manager.applied_currents, undetected_option ), 'Ias', true, applied_current_manager.applied_currents, undetected_option ); end
            ...
            if nargin < 2, delta = self.delta_relative_inversion_DEFAULT; end
            ...
            inversion_parameters{ 2 } = R2;
            inversion_parameters{ 3 } = Gm2;
            inversion_parameters{ 4 } = Ia2;
        ...
        function reduced_inversion_parameters = pack_reduced_relative_inversion_parameters( self, delta, R2, Gm2, Ia2, neuron_manager, applied_current_manager, undetected_option )
            
            % Get parameters from synapse manager: delta1, Gm2, Ia2
            % Get parameters from applied current manager. Gm2, R2
            ...
            % Preallocate a cell to store the parameters.
            reduced_inversion_parameters = cell( 1, 4 );
            
            % Pack the parameters.
            reduced_inversion_parameters{ 1 } = delta;
            reduced_inversion_parameters{ 2 } = R2;
            reduced_inversion_parameters{ 3 } = Gm2;
            reduced_inversion_parameters{ 4 } = Ia2;
        ...
        function division_parameters = pack_relative_division_parameters( self, delta, R3, Gm3, Ia3, neuron_manager, applied_current_manager, undetected_option )
           
            % Get parameters from synapse manager: delta, R3, Gm3, Ia3
            
            % Set the default input arguments.
            if nargin < 8, undetected_option = self.undetected_option_DEFAULT; end
            if nargin < 7, applied_current_manager = self.applied_current_manager; end
            if nargin < 6, neuron_manager = self.neuron_manager; end
            if nargin < 5, Ia3 = applied_current_manager.get_applied_current_property( applied_current_manager.to_neuron_ID2applied_current_ID( neuron_manager.neuron.neuron_IDs( 3 ), applied_current_manager.applied_currents, undetected_option ), 'Ias', true, applied_current_manager.applied_currents, undetected_option ); end
        ...
        function reduced_division_parameters = pack_reduced_relative_division_parameters( self, delta, R3, Gm3, Ia3, neuron_manager, applied_current_manager, undetected_option )
        ...
        function dai_parameters = pack_relative_dai_parameters( self, c1, c3, delta1, delta2, R2, neuron_manager, undetected_option )
           
            % Get parameters from synapse manager: c1, c3, delta1, delta2, R2
        ...
        function reduced_dai_parameters = pack_reduced_relative_dai_parameters( self, delta1, delta2, R2, R3, neuron_manager, undetected_option )
            
           % Get parameters from synapse manager: delta1, delta2, R2, R3, Gm3
           ...
           % Set the default input arguments.
            ...
            % Preallocate a cell to store the parameters.
            reduced_dai_parameters = cell( 1, 4 );
            
            % Pack the parameters.
            reduced_dai_parameters{ 1 } = delta1;
            reduced_dai_parameters{ 2 } = delta2;
            reduced_dai_parameters{ 3 } = R2;
            reduced_dai_parameters{ 4 } = R3;
        ...
        function multiplication_parameters = pack_relative_multiplication_parmaeters( self )
            
           % Get parameters from synapse manager.
           % Get parameters from applied current manager.
        ...
        function reduced_multiplication_parameters = pack_reduced_relative_multiplication_parameters( self )
        ...
        function [ c1, c2, c3, delta1, delta2, R1, R2 ] = unpack_reduced_absolute_dai_parameters( self )
...
%         end
        ...
        function [ Gnas, R2, dEs21, gs21, neurons, synapses, neuron_manager, synapse_manager, self ] = design_transmission_subnetwork( self, neuron_IDs, transmission_parameters, encoding_scheme, neuron_manager, synapse_manager, set_flag, undetected_option )
            ...
            [ dEs21, gs21, ~, synapses, synapse_manager, network ] = network.design_transmission_synapse( neuron_IDs, synapse_parameters, encoding_scheme, synapse_manager, true, undetected_option );
        ...
        function [ Gnas, Rn, dEs, gs, neurons, synapses, neuron_manager, synapse_manager, self ] = design_addition_subnetwork( self, neuron_IDs, addition_parameters, encoding_scheme, neuron_manager, synapse_manager, set_flag, undetected_option )
        ...
        function [ Gnas, Rn, dEs, gs, neurons, synapses, neuron_manager, synapse_manager, self ] = design_subtraction_subnetwork( self, neuron_IDs, subtraction_parameters, encoding_scheme, neuron_manager, synapse_manager, set_flag, undetected_option )
        ...
        function [ Gnas, R2, dEs21, gs21, Ias2, neurons, synapses, applied_currents, neuron_manager, synapse_manager, applied_current_manager, self ] = design_inversion_subnetwork( self, neuron_IDs, inversion_parameters, encoding_scheme, neuron_manager, synapse_manager, applied_current_manager, set_flag, undetected_option )
            ...
            % Convert subnetwork parameters to neuron, synapse, and applied current parameters.
        ...
        function [ Gnas, R3, dEs, gs, neurons, synapses, neuron_manager, synapse_manager, self ] = design_dai_subnetwork( self, neuron_IDs, dai_parameters, encoding_scheme, neuron_manager, synapse_manager, set_flag, undetected_option )
        ...
        function [ Gnas, R3, dEs, gs, neurons, synapses, neuron_manager, synapse_manager, self ] = design_reduced_dai_subnetwork( self, neuron_IDs, reduced_dai_parameters, encoding_scheme, neuron_manager, synapse_manager, set_flag, undetected_option )
...
%         end
        ...
        function [ Gnas, R2, dEs21, gs21, neurons, synapses, neuron_manager, synapse_manager, self ] = create_transmission_subnetwork( self, transmission_parameters, encoding_scheme, neuron_manager, synapse_manager, set_flag, as_cell_flag, undetected_option )
            
            % Set the default input arguments.
            if nargin < 8, undetected_option = self.undetected_option_DEFAULT; end                                    	% [str] Undetected Option.
            if nargin < 7, as_cell_flag = self.as_cell_flag_DEFAULT; end                                                % [T/F] As Cell Flag.
            if nargin < 6, set_flag = self.set_flag_DEFAULT; end                                                        % [T/F] Set Flag.
            if nargin < 5, synapse_manager = self.synapse_manager; end                                                  % [class] Synapse Manager Class.
            if nargin < 4, neuron_manager = self.neuron_manager; end                                                    % [class] Neuron Manager Class.
            if nargin < 3, encoding_scheme = self.encoding_scheme_DEFAULT; end                                          % [str] Encoding Scheme (Must be either: 'absolute' or 'relative'.)
            ...
            [ Gnas, R2, dEs21, gs21, neurons, synapses, neuron_manager, synapse_manager, network ] = network.design_transmission_subnetwork( neuron_IDs, transmission_parameters, encoding_scheme, neuron_manager, synapse_manager, true, undetected_option );
        ...
        function [ Gnas, Rn, dEs, gs, neurons, synapses, neuron_manager, synapse_manager, self ] = create_addition_subnetwork( self, addition_parameters, encoding_scheme, neuron_manager, synapse_manager, set_flag, as_cell_flag, undetected_option )
            ...
            [ Gnas, Rn, dEs, gs, neurons, synapses, neuron_manager, synapse_manager, network ] = network.design_addition_subnetwork( neuron_IDs, addition_parameters, encoding_scheme, neuron_manager, synapse_manager, true, undetected_option );
        ...
        function [ Gnas, Rn, dEs, gs, neurons, synapses, neuron_manager, synapse_manager, self ] = create_subtraction_subnetwork( self, subtraction_parameters, encoding_scheme, neuron_manager, synapse_manager, set_flag, as_cell_flag, undetected_option )
            ...
            [ Gnas, Rn, dEs, gs, neurons, synapses, neuron_manager, synapse_manager, network ] = network.design_subtraction_subnetwork( neuron_IDs, subtraction_parameters, encoding_scheme, neuron_manager, synapse_manager, true, undetected_option );
        ...
        function [ Gnas, R2, dEs21, gs21, Ias2, neurons, synapses, applied_currents, neuron_manager, synapse_manager, applied_current_manager, self ] = create_inversion_subnetwork( self, inversion_parameters, encoding_scheme, neuron_manager, synapse_manager, applied_current_manager, set_flag, as_cell_flag, undetected_option )
            ...
            [ Gnas, R2, dEs21, gs21, Ias2, neurons, synapses, applied_currents, neuron_manager, synapse_manager, applied_current_manager, network ] = network.design_inversion_subnetwork( neuron_IDs, inversion_parameters, encoding_scheme, neuron_manager, synapse_manager, applied_current_manager, true, undetected_option );
        ...
        function [ Gnas, R2, dEs21, gs21, Ias2, neurons, synapses, applied_currents, neuron_manager, synapse_manager, applied_current_manager, self ] = create_reduced_inversion_subnetwork( self, reduced_inversion_parameters, encoding_scheme, neuron_manager, synapse_manager, applied_current_manager, set_flag, as_cell_flag, undetected_option )
            ...
            % Design the inversion subnetwork.
            [ Gnas, R2, dEs21, gs21, Ias2, neurons, synapses, applied_currents, neuron_manager, synapse_manager, applied_current_manager, network ] = network.design_inversion_subnetwork( neuron_IDs, reduced_inversion_parameters, encoding_scheme, neuron_manager, synapse_manager, applied_current_manager, true, undetected_option );
        ...
        function [ Gnas, R3, dEs, gs, neurons, synapses, neuron_manager, synapse_manager, self ] = create_division_subnetwork( self, division_parameters, encoding_scheme, neuron_manager, synapse_manager, set_flag, as_cell_flag, undetected_option )
            ...
            [ Gnas, R3, dEs, gs, neurons, synapses, neuron_manager, synapse_manager, network ] = network.design_division_subnetwork( neuron_IDs, division_parameters, encoding_scheme, neuron_manager, synapse_manager, true, undetected_option );
        ...
        function [ Gnas, R3, dEs, gs, neurons, synapses, neuron_manager, synapse_manager, self ] = create_reduced_division_subnetwork( self, reduced_division_parameters, encoding_scheme, neuron_manager, synapse_manager, set_flag, as_cell_flag, undetected_option )
            ...
            % Design the division subnetwork.
            [ Gnas, R3, dEs, gs, neurons, synapses, neuron_manager, synapse_manager, network ] = network.design_reduced_division_subnetwork( neuron_IDs, reduced_division_parameters, encoding_scheme, neuron_manager, synapse_manager, true, undetected_option );
        ...
        function [ Gnas, R3, dEs, gs, neurons, synapses, neuron_manager, synapse_manager, self ] = create_dai_subnetwork( self, dai_parameters, encoding_scheme, neuron_manager, synapse_manager, set_flag, as_cell_flag, undetected_option )
            ...
            % Design the division subnetwork.
            [ Gnas, R3, dEs, gs, neurons, synapses, neuron_manager, synapse_manager, network ] = network.design_dai_subnetwork( neuron_IDs, dai_parameters, encoding_scheme, neuron_manager, synapse_manager, true, undetected_option );
        ...
        function [ Gnas, R3, dEs, gs, neurons, synapses, neuron_manager, synapse_manager, self ] = create_reduced_dai_subnetwork( self, dai_parameters, encoding_scheme, neuron_manager, synapse_manager, set_flag, as_cell_flag, undetected_option )
            ...
            % Design the division subnetwork.
            [ Gnas, R3, dEs, gs, neurons, synapses, neuron_manager, synapse_manager, network ] = network.design_reduced_dai_subnetwork( neuron_IDs, dai_parameters, encoding_scheme, neuron_manager, synapse_manager, true, undetected_option );
        ...
        function [ Gnas, Rs, dEs, gs, Ias3, neurons, synapses, applied_currents, neuron_manager, synapse_manager, applied_current_manager, self ] = create_multiplication_subnetwork( self, multiplication_parameters, encoding_scheme, neuron_manager, synapse_manager, applied_current_manager, set_flag, as_cell_flag, undetected_option )
            ...
            [ Gnas, Rs, dEs, gs, Ias3, neurons, synapses, applied_currents, neuron_manager, synapse_manager, applied_current_manager, network ] = network.design_multiplication_subnetwork( neuron_IDs, multiplication_parameters, encoding_scheme, neuron_manager, synapse_manager, applied_current_manager, true, undetected_option );
        ...
        function [ Gnas, Rs, dEs, gs, Ias3, neurons, synapses, applied_currents, neuron_manager, synapse_manager, applied_current_manager, self ] = create_reduced_multiplication_subnetwork( self, parameters, encoding_scheme, neuron_input_parameters, synapse_input_parameters, applied_current_input_parameters, neuron_manager, synapse_manager, applied_current_manager, set_flag, as_cell_flag, undetected_option )
            
            % Set the default input arguments.
            if nargin < 12, undetected_option = self.undetected_option_DEFAULT; end                                             % [str] Undetected Option.
            if nargin < 11, as_cell_flag = self.as_cell_flag_DEFAULT; end                                                      	% [T/] As Cell Flag.
            if nargin < 10, set_flag = self.set_flag_DEFAULT; end                                                               % [T/F] Set Flag.
            if nargin < 9, applied_current_manager = self.applied_current_manager; end                                          % [class] Applied Current Manager Class.
            if nargin < 8, synapse_manager = self.synapse_manager; end                                                          % [class] Synapse Manager Class.
            if nargin < 7, neuron_manager = self.neuron_manager; end                                                            % [class] Neuron Manager Class.
            ...
            % Design the multiplication subnetwork.                        
            [ Gnas, Rs, dEs, gs, Ias3, neurons, synapses, applied_currents, neuron_manager, synapse_manager, applied_current_manager, network ] = network.design_reduced_multiplication_subnetwork( neuron_IDs, parameters, encoding_scheme, neuron_manager, synapse_manager, applied_current_manager, true, undetected_option );
