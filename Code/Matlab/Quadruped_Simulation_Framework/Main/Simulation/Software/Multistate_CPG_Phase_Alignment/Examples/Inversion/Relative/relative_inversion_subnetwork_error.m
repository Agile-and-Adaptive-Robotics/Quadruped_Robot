...
% Define the network integration time step.
...
dEs = network.get_dEsyns( 'all' );                                                          % [V] Synaptic Reversal Potentials.

% Define the numerical stability time step.
...
%% Print the Desired and Achieved Relative Inversion Formulation Results.
...
%% Simulate the Relative Inversion Network.
...
%% Plot the Relative Network Results.
