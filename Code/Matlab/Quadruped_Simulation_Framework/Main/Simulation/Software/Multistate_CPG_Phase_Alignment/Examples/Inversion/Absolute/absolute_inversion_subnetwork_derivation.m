%% Absolute Inversion Subnetwork Derivation

% Clear Everything.
clear, close( 'all' ), clc


%% Setup the Absolute Inversion Subnetwork Constraints
...
% Solve the point 1 desired constraint for R2.
...
sc1_sub = subs( sc1, { 'R2', 'c2', 'Ia2', 'gs21' }, [ R2, c2, Ia2, gs21 ] );
sc2_sub = simplify( subs( sc2, { 'R2', 'c2', 'Ia2', 'gs21' }, [ R2, c2, Ia2, gs21 ] ) );
sc3_sub = simplify( subs( sc3, { 'R2', 'c2', 'Ia2', 'gs21' }, [ R2, c2, Ia2, gs21 ] ) );
