...
% R_desired = 20e-3;
R_desired = 200e-3;
epsilon = ( -R_desired + sqrt( R_desired.^2 + 4 ) )/2;
delta = ( -R_desired + sqrt( R_desired.^2 + 4 ) )/2;
...
% [ network, neuron_IDs, synapse_IDs, applied_current_IDs ] = network.create_absolute_inversion_subnetwork( c, epsilon );
[ network, neuron_IDs, synapse_IDs, applied_current_IDs ] = network.create_absolute_inversion_subnetwork( c, epsilon, delta );
