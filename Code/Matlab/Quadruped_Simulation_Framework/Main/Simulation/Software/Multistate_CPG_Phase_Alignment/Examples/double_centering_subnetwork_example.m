%% Double Centering Subnetwork Testing
...
%% Create Double Centering Subnetwork.

% Create an instance of the network class.
network = network_class( network_dt, network_tf );

% Define the double centering subnetwork properties.
k_add = 1;
k_sub = 1;

% Create a double centering subnetwork.
[ network, neuron_IDs, synapse_IDs, applied_current_IDs ] = network.create_double_centering_subnetwork( k_add, k_sub );

% % Disable the double centering subnetwork.
...
% Create applied currents.
[ network.applied_current_manager, applied_current_IDs_in ] = network.applied_current_manager.create_applied_currents( 2 );
network.applied_current_manager = network.applied_current_manager.set_applied_current_property( applied_current_IDs_in( 1 ), 10e-9, 'I_apps' );
network.applied_current_manager = network.applied_current_manager.set_applied_current_property( applied_current_IDs_in( 2 ), 0e-9, 'I_apps' );
network.applied_current_manager = network.applied_current_manager.set_applied_current_property( applied_current_IDs_in, [ neuron_IDs( 1 ) neuron_IDs( 3 ) ], 'neuron_ID' );
