...
[ network, neuron_IDs, synapse_IDs, applied_current_IDs ] = network.create_absolute_division_subnetwork( c, alpha, epsilon );
...
network.applied_current_manager = network.applied_current_manager.set_applied_current_property( applied_current_IDs( 2 ), 0.1e-9, 'I_apps' );
