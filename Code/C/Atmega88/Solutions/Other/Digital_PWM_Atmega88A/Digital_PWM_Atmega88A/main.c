...
unsigned int freq_dac = 4000;							//DAC Frequency.
unsigned int freq_pwm = 40;
...
ISR(TIMER1_COMPA_vect)
{
	...
	adc_data = adc_conversion*ADCW;					//Converts from [0-1023] to [0-4095].
	
	//Compute the duty cycle.
	duty_cycle = duty_cycle_conversion*adc_data;	//Converts from [0-4095] to [0-1] %.
