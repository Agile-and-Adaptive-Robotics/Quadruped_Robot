//Simple Muscle Control Application Main Script.

//This script is compatible with the Matlab simple muscle control application.  Upload this script onto the microcontroller, then start the simple muscle control Matlab application.
//This script takes in "on" and "off" values for each muscle from the associated Matlab app and returns pressure sensor and joint angle feedback information to the associated Matlab app.
